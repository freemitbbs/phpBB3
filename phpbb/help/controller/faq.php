	...
	public function display()
	{
		...
		$faq_blocks = array(
			...
			array(
				...
				false,
				array(
					'HELP_FAQ_UCP_OPTIONS_QUESTION' => 'HELP_FAQ_UCP_OPTIONS_ANSWER',
					'HELP_FAQ_UCP_TOPIC_LIST_QUESTION' => 'HELP_FAQ_UCP_TOPIC_LIST_ANSWER',
					'HELP_FAQ_UCP_ADULT_ACCESS_QUESTION' => 'HELP_FAQ_UCP_ADULT_ACCESS_ANSWER',
					'HELP_FAQ_UCP_TOP_TOPICS_QUESTION' => 'HELP_FAQ_UCP_TOP_TOPICS_ANSWER',
					'HELP_FAQ_UCP_THEME_QUESTION' => 'HELP_FAQ_UCP_THEME_ANSWER',
					'HELP_FAQ_UCP_TOPIC_MOVER_QUESTION' => 'HELP_FAQ_UCP_TOPIC_MOVER_ANSWER',
					'HELP_FAQ_UCP_HIDE_FORUMS_QUESTION' => 'HELP_FAQ_UCP_HIDE_FORUMS_ANSWER',
				),
			),
			array(
				...
				array(
					...
					'HELP_FAQ_DISCOVERY_FOE_LIST_QUESTION' => 'HELP_FAQ_DISCOVERY_FOE_LIST_ANSWER',
