...
$lang = array_merge($lang, array(
	...
	'POSTLOVE_SUMMARY_ABOVE'			=> 'Above the forum list',
		...
		'POSTLOVE_MOST_LIKED_PAGE_LENGTH'	=> 'Standalone page length',
		'POSTLOVE_MOST_LIKED_PAGE_LENGTH_EXPLAIN'	=> 'Number of posts to show in each section on the standalone most-liked posts page.',
		'POSTLOVE_INDEX_EXCLUDED_FORUM_IDS'	=> 'Index excluded forum IDs',
		'POSTLOVE_INDEX_EXCLUDED_FORUM_IDS_EXPLAIN'	=> 'Comma-separated forum IDs whose posts should not appear in the board-index or standalone most-liked posts lists. Example: 12,34,56',
		'POSTLOVE_FORUM_EXCLUDED_FORUM_IDS'	=> 'Forum/category excluded forum IDs',
		'POSTLOVE_FORUM_EXCLUDED_FORUM_IDS_EXPLAIN'	=> 'Comma-separated forum IDs whose posts should not appear in forum or category-scoped most-liked posts lists. On category pages, excluded child forums do not contribute posts. Example: 12,34,56',
