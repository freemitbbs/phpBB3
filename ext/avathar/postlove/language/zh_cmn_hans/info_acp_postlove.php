...
$lang = array_merge($lang, [
	...
	'POSTLOVE_INDEX_EXCLUDED_FORUM_IDS' => '首页排除的版块 ID',
	'POSTLOVE_INDEX_EXCLUDED_FORUM_IDS_EXPLAIN' => '按逗号分隔需要从首页和独立“最多获赞帖子”页面排除的版块 ID。例如：12,34,56',
	'POSTLOVE_FORUM_EXCLUDED_FORUM_IDS' => '版块/分类页排除的版块 ID',
	'POSTLOVE_FORUM_EXCLUDED_FORUM_IDS_EXPLAIN' => '按逗号分隔需要从版块页或分类页“最多获赞帖子”列表排除的版块 ID。在分类页中，被排除的子版块不会参与统计。例如：12,34,56',
