...
$lang = array_merge($lang, [
	...
	'ADULTACCESS_FORUM_IDS_EXPLAIN' => '填写逗号分隔的帖子版块 ID。保存后会备份当前版块权限，把可读取的普通会员权限复制给隐藏的 18+ 确认用户组，并移除非管理人员的版块可见性授权。',
	'ADULTACCESS_GROUP_LABEL' => '隐藏确认用户组',
	'ADULTACCESS_SYNC_EXPLAIN' => '此扩展通过隐藏用户组控制这些版块的访问。将版块移出此列表时，会恢复保存的权限快照。',
