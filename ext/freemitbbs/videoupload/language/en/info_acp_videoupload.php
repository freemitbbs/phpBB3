...
$lang = array_merge($lang, [
	...
	'VIDEOUPLOAD_EXPLAIN' => 'Upload media files (video/audio) to S3-compatible storage and insert direct media URLs into posts.',
	'VIDEOUPLOAD_FIELDSET_GENERAL' => 'General settings',
	'VIDEOUPLOAD_FIELDSET_S3' => 'S3 storage settings',

	'VIDEOUPLOAD_ENABLED' => 'Enable media upload',
	'VIDEOUPLOAD_ENABLED_EXPLAIN' => 'Enable or disable the posting editor media upload control.',
	'VIDEOUPLOAD_MAX_SIZE_MB' => 'Max file size (MB)',
	'VIDEOUPLOAD_MAX_SIZE_MB_EXPLAIN' => 'Maximum upload size for each media file.',
	...
	'VIDEOUPLOAD_S3_BUCKET_EXPLAIN' => 'Bucket where uploaded media files are stored.',
