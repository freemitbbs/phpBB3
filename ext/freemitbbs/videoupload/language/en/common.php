...
$lang = array_merge($lang, [
	'VIDEOUPLOAD_BUTTON' => 'Upload media',
	'VIDEOUPLOAD_HELP_WITH_LIMIT' => 'Supported formats: %1$s. Max file size: %2$s.',
	'VIDEOUPLOAD_UPLOADING' => 'Uploading media...',
	'VIDEOUPLOAD_UPLOAD_SUCCESS' => 'Media uploaded. URL inserted into editor.',
	'VIDEOUPLOAD_ERR_SERVER' => 'Upload failed. Please try again.',
	'VIDEOUPLOAD_ERR_DISABLED' => 'Media upload is disabled.',
	'VIDEOUPLOAD_ERR_LOGIN_REQUIRED' => 'Please sign in to upload media files.',
	'VIDEOUPLOAD_ERR_METHOD' => 'Invalid request method.',
	'VIDEOUPLOAD_ERR_FORM' => 'Invalid form token.',
	'VIDEOUPLOAD_ERR_FORUM' => 'Invalid forum.',
	'VIDEOUPLOAD_ERR_PERMISSION' => 'You do not have permission to upload media files in this forum.',
	'VIDEOUPLOAD_ERR_MISSING_CONFIG' => 'Media upload storage is not configured.',
	...
	'VIDEOUPLOAD_ERR_BAD_URL' => 'Upload completed, but the resulting URL does not end with a supported media extension.',
]);
