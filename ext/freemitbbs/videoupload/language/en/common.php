...
$lang = array_merge($lang, [
	'VIDEOUPLOAD_BUTTON' => 'Upload video',
	'VIDEOUPLOAD_HELP_WITH_LIMIT' => 'Supported formats: %1$s. Max file size: %2$s.',
	'VIDEOUPLOAD_UPLOADING' => 'Uploading video...',
	'VIDEOUPLOAD_UPLOAD_SUCCESS' => 'Video uploaded. URL inserted into editor.',
	'VIDEOUPLOAD_ERR_SERVER' => 'Upload failed. Please try again.',
	'VIDEOUPLOAD_ERR_DISABLED' => 'Video upload is disabled.',
	'VIDEOUPLOAD_ERR_LOGIN_REQUIRED' => 'Please sign in to upload videos.',
	'VIDEOUPLOAD_ERR_METHOD' => 'Invalid request method.',
	'VIDEOUPLOAD_ERR_FORM' => 'Invalid form token.',
	'VIDEOUPLOAD_ERR_FORUM' => 'Invalid forum.',
	'VIDEOUPLOAD_ERR_PERMISSION' => 'You do not have permission to upload videos in this forum.',
	'VIDEOUPLOAD_ERR_MISSING_CONFIG' => 'Video upload storage is not configured.',
	...
	'VIDEOUPLOAD_ERR_BAD_URL' => 'Upload completed, but the resulting URL does not end with .mp4, .ogg, or .webm.',
]);
