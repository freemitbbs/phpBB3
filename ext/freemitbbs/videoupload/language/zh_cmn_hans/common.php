...
$lang = array_merge($lang, [
	'VIDEOUPLOAD_BUTTON' => '上传媒体',
	'VIDEOUPLOAD_HELP_WITH_LIMIT' => '支持格式：%1$s。单个文件最大：%2$s。',
	'VIDEOUPLOAD_UPLOADING' => '正在上传媒体...',
	'VIDEOUPLOAD_UPLOAD_SUCCESS' => '媒体上传成功，链接已插入编辑器。',
	'VIDEOUPLOAD_ERR_SERVER' => '上传失败，请稍后重试。',
	'VIDEOUPLOAD_ERR_DISABLED' => '媒体上传功能已关闭。',
	'VIDEOUPLOAD_ERR_LOGIN_REQUIRED' => '请先登录再上传媒体文件。',
	'VIDEOUPLOAD_ERR_METHOD' => '请求方法无效。',
	'VIDEOUPLOAD_ERR_FORM' => '表单令牌无效。',
	'VIDEOUPLOAD_ERR_FORUM' => '版面参数无效。',
	'VIDEOUPLOAD_ERR_PERMISSION' => '你没有在该版面上传媒体文件的权限。',
	'VIDEOUPLOAD_ERR_MISSING_CONFIG' => '媒体上传存储配置不完整。',
	...
	'VIDEOUPLOAD_ERR_BAD_URL' => '上传完成，但返回链接的扩展名不在受支持的媒体格式内。',
]);
