...
$lang = array_merge($lang, [
	...
	'VIDEOUPLOAD_EXPLAIN' => '将媒体文件（视频/音频）上传到兼容 S3 的存储，并在帖子中插入可直接访问的媒体链接。',
	'VIDEOUPLOAD_FIELDSET_GENERAL' => '基本设置',
	'VIDEOUPLOAD_FIELDSET_S3' => 'S3 存储设置',

	'VIDEOUPLOAD_ENABLED' => '启用媒体上传',
	'VIDEOUPLOAD_ENABLED_EXPLAIN' => '开启或关闭发帖编辑器中的媒体上传控件。',
	'VIDEOUPLOAD_MAX_SIZE_MB' => '最大文件大小（MB）',
	'VIDEOUPLOAD_MAX_SIZE_MB_EXPLAIN' => '单个媒体文件允许的最大上传大小。',
	...
	'VIDEOUPLOAD_S3_BUCKET_EXPLAIN' => '上传媒体文件要存放的 Bucket。',
