...
$lang = array_merge($lang, [
	...
	'TOPTOPICS_SUMMARY_POSITION_BELOW' => 'Below the forum list',
		...
		'TOPTOPICS_FLAT_TOPIC_LIST_PER_PAGE' => 'Flat topic list topics per page',
		'TOPTOPICS_FLAT_TOPIC_LIST_PER_PAGE_EXPLAIN' => 'Number of topics shown per page in the index flat topic list.',
	...
	'TOPTOPICS_POST_COLLAPSE_DISLIKE_THRESHOLD' => 'Collapse or hide after net dislikes',
	'TOPTOPICS_POST_COLLAPSE_DISLIKE_THRESHOLD_EXPLAIN' => 'Posts where TopTopics dislikes exceed likes by at least this many are collapsed in topic view. If the topic\'s first post reaches this net score, the topic is excluded from Top Topics and Recent Topics lists. Use 0 to disable.',
	...
	'TOPTOPICS_REPLY_WEIGHT' => 'Non-author reply engagement weight',
	'TOPTOPICS_REPLY_WEIGHT_EXPLAIN' => 'Weight applied to ln(1 + non-author replies) before time decay. Higher values let active discussion by other users lift a topic sooner.',
	...
	'TOPTOPICS_DISCUSSION_REPLY_MINIMUM' => 'Non-author reply count for discussion penalty',
	'TOPTOPICS_DISCUSSION_REPLY_MINIMUM_EXPLAIN' => 'Minimum non-author replies before the discussion imbalance check is applied.',
	'TOPTOPICS_DISCUSSION_REPLY_LIKE_RATIO' => 'Non-author reply-to-like ratio penalty',
	'TOPTOPICS_DISCUSSION_REPLY_LIKE_RATIO_EXPLAIN' => 'If non-author replies exceed likes by more than this ratio, the discussion penalty is applied.',
