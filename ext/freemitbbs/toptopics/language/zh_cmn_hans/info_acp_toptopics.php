...
$lang = array_merge($lang, [
	...
	'TOPTOPICS_SUMMARY_POSITION_BELOW' => '论坛列表下方',
		...
		'TOPTOPICS_FLAT_TOPIC_LIST_PER_PAGE' => '无版列表每页话题数',
		'TOPTOPICS_FLAT_TOPIC_LIST_PER_PAGE_EXPLAIN' => '首页无版新帖列表中每页显示多少条话题。',
		'TOPTOPICS_PER_FORUM_LIMIT' => '每个版块的话题数量上限',
		'TOPTOPICS_PER_FORUM_LIMIT_EXPLAIN' => '在跨多个版块的同一个“热门话题”列表中，同一版块最多允许显示多少条话题。填 0 表示禁用此均衡限制。',
	...
	'TOPTOPICS_POST_COLLAPSE_DISLIKE_THRESHOLD' => '净踩达到多少后折叠或隐藏',
	'TOPTOPICS_POST_COLLAPSE_DISLIKE_THRESHOLD_EXPLAIN' => '帖子收到的 TopTopics 踩比赞至少多这么多时，会在主题页中折叠；如果主贴达到这个净值，整个话题会从热门话题和最近话题列表中移除。填 0 表示禁用。',
	...
	'TOPTOPICS_REPLY_WEIGHT' => '非作者回复参与权重',
	'TOPTOPICS_REPLY_WEIGHT_EXPLAIN' => '在时间衰减前，对 ln(1 + 非作者回复数) 应用的权重。值越大，其他用户的活跃讨论越容易抬升话题。',
	...
	'TOPTOPICS_DISCUSSION_REPLY_MINIMUM' => '触发讨论惩罚的最少非作者回复数',
	'TOPTOPICS_DISCUSSION_REPLY_MINIMUM_EXPLAIN' => '只有非作者回复数达到这个值后，才会检查讨论失衡惩罚。',
	'TOPTOPICS_DISCUSSION_REPLY_LIKE_RATIO' => '非作者回复对赞比例惩罚阈值',
	'TOPTOPICS_DISCUSSION_REPLY_LIKE_RATIO_EXPLAIN' => '当非作者回复数超过赞数达到这个比例时，会应用讨论惩罚。',
