...
$lang = array_merge($lang, [
	...
	'CARDGAMESAUTH_TESTING_MODE_EXPLAIN' => '默认启用。启用后，普通用户看不到卡牌游戏；只有测试组用户可以打开客户端或获取游戏令牌。只有确认游戏可以向所有允许用户开放后，才关闭此项。',
	'CARDGAMESAUTH_CLIENT_URL' => '客户端 URL 或路径',
	'CARDGAMESAUTH_CLIENT_URL_EXPLAIN' => '卡牌游戏客户端的路径或 URL。留空时使用扩展内置客户端 /app.php/card-games/client。',
	'CARDGAMESAUTH_LAUNCH_REDIRECT' => '启动页直接跳转到客户端',
	'CARDGAMESAUTH_LAUNCH_REDIRECT_EXPLAIN' => '启用后，允许访问的用户打开 /app.php/card-games 时会直接跳转到配置的客户端 URL。',
	...
	'CARDGAMESAUTH_PROXY_ENABLED_EXPLAIN' => '允许外部游戏服务器调用经过认证的 /app.php/card-games/server/* JSON 接口。',
	...
	'CARDGAMESAUTH_NODE_RUNTIME_BASE_URL_EXPLAIN' => 'Node 运行时 Hook API 的本机基础 URL，例如 http://127.0.0.1:8080。不要包含具体操作路径。',
	...
	'CARDGAMESAUTH_NODE_RUNTIME_TIMEOUT_MS_EXPLAIN' => '等待运行时 Hook 响应的毫秒数。默认 10000。允许范围：1000-30000。',
]);
