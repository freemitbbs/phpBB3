...
$lang = array_merge($lang, [
	...
	'CARDGAMESAUTH_FIELDSET_SENTRY' => '客户端错误上报',
	...
	'CARDGAMESAUTH_SENTRY_ENABLED' => '为客户端启用 Sentry',
	'CARDGAMESAUTH_SENTRY_ENABLED_EXPLAIN' => '在卡牌游戏客户端页面加载 Sentry 浏览器 SDK，上报未捕获的客户端错误。只有同时启用此项并填写 DSN 时才会生效。',
	'CARDGAMESAUTH_SENTRY_DSN' => 'Sentry 浏览器 DSN',
	'CARDGAMESAUTH_SENTRY_DSN_EXPLAIN' => '浏览器端 Sentry 项目的公开 DSN。该值会暴露给客户端，应指向客户端项目/环境。',
	'CARDGAMESAUTH_SENTRY_ENVIRONMENT' => 'Sentry 环境',
	'CARDGAMESAUTH_SENTRY_ENVIRONMENT_EXPLAIN' => '随客户端事件发送的环境标签，例如 production 或 staging。',
	'CARDGAMESAUTH_SENTRY_RELEASE' => 'Sentry 发布版本',
	'CARDGAMESAUTH_SENTRY_RELEASE_EXPLAIN' => '可选的发布版本名，用于按部署版本归类客户端错误。',
	'CARDGAMESAUTH_SENTRY_CDN_URL' => 'Sentry CDN bundle URL',
	'CARDGAMESAUTH_SENTRY_CDN_URL_EXPLAIN' => '游戏客户端页面加载的浏览器 SDK bundle。默认使用不含 Replay 的 Sentry CDN bundle。',
	'CARDGAMESAUTH_SENTRY_SAMPLE_RATE' => '错误采样率',
	'CARDGAMESAUTH_SENTRY_SAMPLE_RATE_EXPLAIN' => '要发送的错误事件比例。1 表示全部错误，0.1 表示 10%。允许范围：0-1。',
	'CARDGAMESAUTH_SENTRY_TRACES_SAMPLE_RATE' => '性能追踪采样率',
	'CARDGAMESAUTH_SENTRY_TRACES_SAMPLE_RATE_EXPLAIN' => '要发送的性能追踪比例。保持 0 可关闭浏览器追踪并避免额外请求头。允许范围：0-1。',
