...
$lang = array_merge($lang, [
	...
	'TOPICMOVER_THRESHOLD' => '回复数阈值',
	'TOPICMOVER_THRESHOLD_EXPLAIN' => '只有论坛 ID 2 中回复数大于此值的主题会被处理。默认值为 5。',
	...
	'TOPICMOVER_MODEL_EXPLAIN' => '发送到 chat completions 请求中的模型 ID。默认 deepseek-chat。',
