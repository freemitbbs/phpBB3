...
interface driver_interface
{
	 ...
	 * This is used when the extension needs to provide its own tokenization,
	 * such as for CJK titles on databases without suitable full-text parsers.
	 *
	 * @param int   $topic_id    The ID of the main topic
	 * @param array $terms       The tokenized search terms
	 * @param int   $length      The length of time of the search period
	 * @param float $sensitivity The search score weighting
	 * @return array An SQL query array
	 */
