...
$lang = array_merge($lang, array(
	...
	'NO_KEYWORDS'			=> '您必须指定至少一个关键词，且每个关键词必须为 %s 到 %s 个字符，不包含通配符。',
	'NO_RECENT_SEARCHES'	=> '没有找到最近的搜索操作。',
	'NO_SEARCH'				=> '对不起您不能使用搜索系统。',
	'NO_SEARCH_RESULTS'		=> '没有搜索到符合条件的结果。',
	...
	'RESULT_DAYS'			=> '将搜索结果限制到最近',
	'RESULT_SORT'			=> '将搜索结果按此排序',
	'RETURN_FIRST'			=> '将搜索结果限制为每贴',
	'RETURN_FIRST_EXPLAIN'	=> '设置成 0 以显示完整的帖子。',
	...
	'SEARCH_KEYWORDS_EXPLAIN'	=> '在关键词前放置 <strong>+</strong> 号，表示搜索结果必须包含该词；在关键词前面放置 <strong>-</strong> 号，搜索结果将不包含该词。如果一系列关键词中出现一个即可，在括号中间放置搜索词列表，词与词间用 <strong>|</strong> 隔开。使用 * 作为通配符。',
