...
$lang = array_merge($lang, array(
	'CLI_APCU_CACHE_NOTICE'				=> 'APCu 缓存经由管理员控制面板被清掉。',
	
	'CLI_CONFIG_CANNOT_CACHED'			=> '如果配置选项修改频繁而无法有效缓存，请加上这个选项。',
	'CLI_CONFIG_CURRENT'				=> '当前配置值，使用 0 和 1 表示布尔值',
	'CLI_CONFIG_DELETE_SUCCESS'			=> '成功删除配置项 %s。',
	'CLI_CONFIG_NEW'					=> '新的配置值，使用 0 和 1 表示布尔值',
	'CLI_CONFIG_NOT_EXISTS'				=> '配置项 %s 不存在',
	'CLI_CONFIG_OPTION_NAME'			=> '配置选项的名称',
	'CLI_CONFIG_PRINT_WITHOUT_NEWLINE'	=> '如果打印值时末尾不带换行，请启用设置这个选项。',
	'CLI_CONFIG_INCREMENT_BY'			=> '增加的数额',
	'CLI_CONFIG_INCREMENT_SUCCESS'		=> '成功增加配置项 %s',
	'CLI_CONFIG_SET_FAILURE'			=> '无法设置配置项 %s',
	'CLI_CONFIG_SET_SUCCESS'			=> '成功设置配置项 %s',

	'CLI_DESCRIPTION_CRON_LIST'					=> '打印包括已准备和未准备的计划任务列表。',
	'CLI_DESCRIPTION_CRON_RUN'					=> '执行所有已准备之计划任务。',
	'CLI_DESCRIPTION_CRON_RUN_ARGUMENT_1'		=> '将要执行的任务名称',
	...
	'CLI_DESCRIPTION_DISABLE_EXTENSION'			=> '停用指定扩展。',
	'CLI_DESCRIPTION_ENABLE_EXTENSION'			=> '启用指定扩展。',
	'CLI_DESCRIPTION_FIND_MIGRATIONS'			=> '查找不依赖于此的改变。',
	'CLI_DESCRIPTION_FIX_LEFT_RIGHT_IDS'		=> '修复论坛和模块的树结构。',
	...
	'CLI_DESCRIPTION_OPTION_ENV'				=> '环境变量名称',	
	...
	'CLI_DESCRIPTION_REPARSER_REPARSE'			=> '用当前的 文本格式器 服务来解析储存的文本。',
	'CLI_DESCRIPTION_REPARSER_REPARSE_ARG_1'	=> '要解析的文本类型。留空表示解析所有类型。',
	'CLI_DESCRIPTION_REPARSER_REPARSE_OPT_DRY_RUN'		=> '不要保存任何改变；只打印变动内容。',
	'CLI_DESCRIPTION_REPARSER_REPARSE_OPT_FORCE_BBCODE'	=> '重新解析所有的 BBCodes，没有例外。注意任何之前禁用的 BBCodes 将被重新处理，启用并完全渲染。',
	...
	'CLI_DESCRIPTION_REPARSER_REPARSE_OPT_RESUME'		=> '从上次停止的地方开始解析。',	
	...
	'CLI_DESCRIPTION_UPDATE_CHECK'					=> '检查论坛程序是否已是最新版本。',
	...
	'CLI_DESCRIPTION_UPDATE_HASH_BCRYPT'		=> '把过时的密码摘要方式更新为 bcrypt。 ',

	'CLI_ERROR_INVALID_STABILITY' => '"%s" 应该被设置为 "stable" 或者 "unstable"。',

	'CLI_DESCRIPTION_USER_ACTIVATE'				=> '激活 （或停用） 用户账号。',
	'CLI_DESCRIPTION_USER_ACTIVATE_USERNAME'	=> '要激活的用户名。',
	'CLI_DESCRIPTION_USER_ACTIVATE_DEACTIVATE'	=> '停用用户帐号',
	'CLI_DESCRIPTION_USER_ACTIVATE_ACTIVE'		=> '用户账号已经被激活。.',
	'CLI_DESCRIPTION_USER_ACTIVATE_INACTIVE'	=> '用户账号已经被停用。',
	...
	'CLI_DESCRIPTION_USER_ADD_OPTION_EMAIL'		=> '新用户的 email 地址',
	'CLI_DESCRIPTION_USER_ADD_OPTION_NOTIFY'	=> '发送新用户账号激活邮件 （默认不发送）',
	'CLI_DESCRIPTION_USER_DELETE'				=> '删除一个用户账号。',
	'CLI_DESCRIPTION_USER_DELETE_USERNAME'		=> '要删除的账号的用户名',
	'CLI_DESCRIPTION_USER_DELETE_ID'			=> '根据用户 ID 删除账号。',
	'CLI_DESCRIPTION_USER_DELETE_ID_OPTION_ID'	=> '要删除的用户的用户 ID',
	'CLI_DESCRIPTION_USER_DELETE_OPTION_POSTS'	=> '删除该用户的所有帖子。不选择的话，该用户的帖子会被保留。',
	'CLI_DESCRIPTION_USER_RECLEAN'				=> '重新清理用户名。',
	
	'CLI_EXTENSION_DISABLE_FAILURE'		=> '无法停用扩展 %s',
	'CLI_EXTENSION_DISABLE_SUCCESS'		=> '成功停用扩展 %s',
	'CLI_EXTENSION_DISABLED'			=> '扩展 %s 没有启用',
	'CLI_EXTENSION_ENABLE_FAILURE'		=> '无法启用扩展 %s',
	'CLI_EXTENSION_ENABLE_SUCCESS'		=> '成功启用扩展 %s',
	'CLI_EXTENSION_ENABLED'				=> '扩展 %s 已经启用',
	...
	'CLI_EXTENSION_NOT_ENABLEABLE'		=> '扩展 %s 无法启用。',
	'CLI_EXTENSIONS_AVAILABLE'			=> '可用的',
	'CLI_EXTENSIONS_DISABLED'			=> '已停用',
	'CLI_EXTENSIONS_ENABLED'			=> '已启用',

	'CLI_FIXUP_FIX_LEFT_RIGHT_IDS_SUCCESS'		=> '成功修复论坛和模块的树结构。',
	'CLI_FIXUP_UPDATE_HASH_BCRYPT_SUCCESS'		=> '成功的用 bcrypt 更新密码摘要。 ',

	'CLI_MIGRATION_NAME'					=> '迁移名字，包括命名空间 （用正斜杠代替反斜杠以避免错误）。',
	'CLI_MIGRATIONS_AVAILABLE'				=> '可用的迁移',
	'CLI_MIGRATIONS_INSTALLED'				=> '已安装的迁移',
	'CLI_MIGRATIONS_ONLY_AVAILABLE'		    => '只显示可用的迁移',
	'CLI_MIGRATIONS_EMPTY'                  => '没有迁移。',
	...
	'CLI_THUMBNAIL_NOTHING_TO_DELETE'	=> '没有缩略图可删除。',	
	
	
	'CLI_USER_ADD_SUCCESS'		=> '成功添加用户 %s。',
	'CLI_USER_DELETE_CONFIRM'	=> '您确认要删除用户 ‘%s’ 吗？ [y/N]',
	'CLI_USER_DELETE_ID_CONFIRM'	=> '您确认要删除用户  ID 为 ‘%s’？ [y/N]',
	'CLI_USER_DELETE_ID_SUCCESS'	=> '成功删除用户 ID。',
	'CLI_USER_DELETE_ID_START'		=> '根据 ID 删除用户',
	'CLI_USER_DELETE_NONE'			=> '按用户 ID 没有删除任何用户。',
...
$lang = array_merge($lang, array(
	...
	'CLI_HELP_USER_ACTIVATE'	=> '激活一个用户，或者使用 <info>--deactivate</info> 选项停用一个用户。可以使用  <info>--send-email</info> 选项，来发送一个激活 email 给用户。',
	'CLI_HELP_USER_ADD'			=> ' <info>%command.name%</info> 命令添加了一个新用户： 
如果这个命令没有附带选项，那么您将被提示输入这些选项。
可以使用 <info>--send-email</info> 选项，来发送一个 email 给新用户。',
	'CLI_HELP_USER_RECLEAN'		=> '重新清理用户名会检查所有储存的用户名，并确认其清洁版本被保存。清理过的用户名是大小写无关的格式，并且是 NFC 标准化和 ASCII 格式的。',
));
