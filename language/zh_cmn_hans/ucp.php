...
$lang = array_merge($lang, array(
	'TERMS_OF_USE_CONTENT'	=> '对 “%1$s” （下文中指代 “我们”，“我们的”，“%1$s”，“%2$s”）的访问，表明您同意并遵守以下具有法律效力之条款。如果您不同意以下条款，请停止访问和使用 “%1$s”。我们可能随时更改这些条款，并且我们会尽最大努力通知您，然而您有责任定期自行查看条款，因为在条款更改后您继续使用 “%1$s” 即表示您同意在这些条款更新和/或修订后受其法律约束。<br>
	<br>
	我们的论坛运行使用 phpBB （下文中指代 “他们”， “他方”， “他们的”， “phpBB 软件”， “www.phpbb.com”， “phpBB 有限公司”， “phpBB 团队”）， 这是一个使用 “<a href="https://opensource.org/license/gpl-2-0">GNU General Public License v2</a>” （下文指代 "GPL"） 软件协议的公告栏系统解决方案， 可以从 <a href="https://www.phpbb.com/">www.phpbb.com</a> 下载获得。 phpBB 软件仅促进基于 Internet 的讨论， phpBB 有限公司对本网站允许或者禁止的内容或行为概不负责。 如果希望得到更多关于 phpBB 的信息， 请访问: <a href="https://www.phpbb.com/">https://www.phpbb.com/</a>。<br>
	<br>
	您同意不发布任何带有辱骂性，淫秽，粗俗，诽谤性，仇恨，威胁，色情或其它非法的内容，无论这些内容违反的是您所在国家的法律，或 “%1$s” 所托管的国家的法律，还是国际法。以上的行为可能会使您被立即永远封禁，若有必要会通知您的互联网服务提供商。所有帖子发表所使用的 IP 地址将被记录，以协助调查违反条款的事件。
	<br><br>
	您同意 “%1$s” 保留随时自行决定删除，修改，移动，或关闭任何主题的权力。作为一个用户，您同意您所输入的任何信息将被记录至数据库。虽然在没有得到您同意的前提下我们不会向任何第三方透露这些信息，但是 “%1$s” 和 phpBB 不为任何因为黑客行为导致的数据泄漏承担法律责任。
	',

	'PRIVACY_POLICY'		=> '本政策用于详细解释 “%1$s” 和其附属的公司 （下文中指代 “我们”, “我方”， “我们的”， “%1$s”, “%2$s”） 和 phpBB （下文指代 “他们”， “他方”， “他们的”， “phpBB 软件”， “www.phpbb.com”， “phpBB 有限公司”， “phpBB 团队”） 如何使用在与您的会话中得到的与您有关的信息 （下文中指代 “您的信息”）。<br>
	<br>
	您的信息通过两种方式收集。 首先， 通过浏览 “%1$s” 将使 phpBB 软件生成多个 cookie 文件， 这些 cookie 是存储在您浏览器临时文件中的小型文本文件。 其中前两个 cookie 包含用户标识符 (下文指代 “用户ID”) 和一个匿名会话标识符 （下文中指代 “对话ID”），这两个标识符 将被 phpBB 软件自动分配。 当您浏览 “%1$s” 中的主题后，系统会生成第三个cookie， 用于存储已阅读的主题信息， 从而改善用户体验。<br>
	<br>
	第二种是我们通过您提交的内容收集到的您的信息。 这包括但不限于：以匿名用户发帖 (下文中指代 “匿名帖子”)， 在 “%1$s” 上注册帐号 (下文中指代 “您的帐号”) 您在注册登录账号后发表的帖子 (下文中指代 “您的帖子”)。<br>
	<br>
	您的帐号将至少包含：一个唯一的用户名 (下文中指代 “您的用户名”)， 一个用于登录您的帐号的个人密码 (下文中指代 “您的密码”) 和一个个人的， 有效的 email 地址 (下文中指代 “您的 email”)。 您在 “%1$s” 上的帐号所包含的信息将受到我们服务器所在国家的数据保护法律的保护。 除了您的用户名和您的密码以及在注册过程中 “%1$s” 要求的 email 地址以外， 您的其他任何信息或者是必填项或者是可选项，这基于 “%1$s” 的决定。 在任何情况下， 您可以选择您的哪些信息是否被公开。 此外， 在您的帐号中， 您可以选择接收或不接收 phpBB 软件自动生成的 email。<br>
	<br>
	您的密码以单向哈希加密形式存在。 但是，我们建议您不要在多个网站上重复使用相同的密码。 您的密码是您在  “%1$s” 上访问您的帐号的途径， 所以请谨慎保管您的密码。 在任何情况下 “%1$s” ，phpBB，  或者任何第三方有关联得任何人都不会以任何政党理由向您索要密码。 如果您忘记了密码， 您可以使用 phpBB 软件提供的 “忘记密码” 功能。 在找回密码的过程中您将要回答您的用户名和您的 email， 而后 phpBB 软件将会提供一个新的密码让您取回帐号。<br>
	',
));
