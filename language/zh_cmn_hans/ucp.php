...
$lang = array_merge($lang, array(
	'TERMS_OF_USE_CONTENT'	=> '对 “%1$s” （下文中指代 “我们”，“我们的”，“%1$s”，“%2$s”）的访问，表明您同意并遵守以下具有法律效力之条款。如果您不同意以下条款，请停止访问和使用 “%1$s”。我们可能随时更改这些条款，并且我们会尽最大努力通知您，但您最好定期自行查看，因为在条款更改后您继续使用 “%1$s” 即表示您同意在这些条款更新和/或修订后受其法律约束。<br>
	<br>
	我们的论坛运行使用 phpBB （下文中指代 “他们”， “他方”， “他们的”， “phpBB 软件”， “www.phpbb.com”， “phpBB 组”， “phpBB 团队”）， 这是一个使用 “<a href="http://opensource.org/licenses/gpl-2.0.php">GNU General Public License v2</a>” （下文指代 "GPL"） 软件协议的公告栏系统解决方案， 可以从 <a href="https://www.phpbb.com/">www.phpbb.com</a> 下载获得。 phpBB 软件仅促进基于 Internet 的讨论， phpBB 组不对所讨论的内容负责。 如果希望得到更多关于 phpBB 的信息， 请访问: <a href="https://www.phpbb.com/">https://www.phpbb.com/</a>。<br>
	<br>
	您同意不张贴任何带有辱骂，淫秽，粗俗，诽谤，仇恨，威胁，色情的内容，不张贴任何带有侵犯您所在国家的法律， “%1$s” 所在国家的法律，国际公法的内容。以上的行为可能会使您在未得到通知的情况下被永远禁止访问这个论坛，若有必要会通知您的互联网服务提供商。所有帖子发表所使用的 IP 地址将被记录，以协助调查违反条款的事件。您同意 “%1$s” 具有在任何我们认为合适的时候删除，修改，移动，或关闭任何主题的权力。作为一个用户，您同意您所输入的任何信息将被记录至数据库。在没有得到您同意的前提下我们不会向任何第三方发布这些信息，但是 “%1$s” 和 phpBB 不为任何因为黑客行为导致的数据泄漏承担法律责任。
	',

	'PRIVACY_POLICY'		=> '本政策用于详细解释 “%1$s” 和其附属的公司 （下文中指代 “我们”, “我方”， “我们的”， “%1$s”, “%2$s”） 和 phpBB （下文指代 “他们”， “他方”， “他们的”， “phpBB 软件”， “www.phpbb.com”， “phpBB Limited”， “phpBB 团队”） 如何使用在与您的会话中得到的与您有关的信息 （下文中指代 “您的信息”）。<br>
	<br>
	您的信息通过两种方式收集。 首先， 通过浏览 “%1$s” 将使 phpBB 软件在您的电脑中生成一定数量的 cookie 文件， 这些 cookie 是浏览器用于缓存信息的临时文件。 其中前两个 cookie 包含用户的 ID 信息 (下文指代 “用户ID”) 和一个匿名的用户对话 ID （下文中指代 “对话ID”）， 将被 phpBB 软件自动分配给您。 第三个cookie 将在您浏览 “%1$s” 中的主题后自动产生， 用于存储已阅读的主题， 用于提高用户体验。<br>
	<br>
	phpBB软件在浏览 “%1$s” 时，除了上述的 cookies 外，或许我们会使用其它外部 cookie 来储存信息， 但这已经超出了本文档的范围。 第二种是我们通过您提交的内容收集到的您的信息。 这种情况是但是不局限于：以匿名用户发帖 (下文中指代 “匿名帖子”)， 在 “%1$s” 上注册帐号 (下文中指代 “您的帐号”) 登录动作和您在注册后发表的帖子 (下文中指代 “您的帖子”)。<br>
	<br>
	您的帐号将至少包含一个唯一的用户名 (下文中指代 “您的用户名”)， 一个用于登录您的帐号的个人密码 (下文中指代 “您的密码”) 和一个个人的， 有效的 email 地址 (下文中指代 “您的 email”)。 您在 “%1$s” 上的帐号所包含的信息将受到我们所在国家的数据保护法律的保护。 除了您的用户名和您的密码以及在注册过程中 “%1$s” 要求的 email 地址以外， 您的其他任何信息或者是强制的或者是可选的，这基于 “%1$s” 的决定。 在任何情况下， 您可以选择您的信息是否被公开。 此外， 在您的帐号中， 您可以选择接收或推出 phpBB 软件自动生成的 email。<br>
	<br>
	您的密码以加密形式存在 （单向哈希）， 所以它是安全的。 但是， 我们希望您不要在不同的网站上重复使用相同的密码。 您的密码是您在  “%1$s” 上访问您的帐号的途径， 所以请谨慎保管您的密码，并且在任何情况下与 “%1$s” ，phpBB，  或者任何第三方有关联得任何人都不会合法的向您索要密码。 如果您忘记了您的密码， 您可以使用 phpBB 软件提供的 “我忘记了自己的密码” 功能。 在找回密码的过程中您将要回答您的用户名和您的 email， 而后 phpBB 软件将会提供一个新的密码让您取回帐号。<br>
	',
));
...
$lang = array_merge($lang, array(
	...
	'ATTACHMENT_LOCKED'				=> '主题已锁定，您无法删除附件。',
	...
	'BOARD_DATE_FORMAT'			=> '我的日期时间格式',
	'BOARD_DATE_FORMAT_EXPLAIN'	=> '语法使用与 PHP 相同，参考  <a href="https://www.php.net/manual/datetime.format.php">date functions</a> 函数。',
	'BOARD_LANGUAGE'			=> '我的语言',
	'BOARD_STYLE'				=> '我的论坛风格',
	'BOARD_TIMEZONE'			=> '我的时区',
	'BOOKMARKS'					=> '收藏夹',
	...
	'FOES_EXPLAIN'				=> '黑名单列表上的用户默认被忽略。这些用户的帖子将不完全显示，但允许对您发送站内短信。请注意这不能阻止版主和管理员的短信。',
	...
	'MESSAGE_REPORTED_MESSAGE'		=> '被举报短信',
	'MESSAGE_SENT_ON'				=> '时间',
	...
	'NOTIFICATION_TYPE_GROUP_REQUEST'					=> '有人请求加入您领导的组',
	'NOTIFICATION_TYPE_FORUM'							=> '有人在您订阅的版面回复了一个主题',
	...
	'NOTIFICATION_TYPE_REPORT_CLOSED'					=> '您对某个帖子的举报已经由版主关闭',
	'NOTIFICATION_TYPE_REPORT_PM'						=> '有人举报了一个私信',
	'NOTIFICATION_TYPE_REPORT_PM_CLOSED'				=> '您对一个私信的举报已经被版主关闭',
	...
	'PASS_TYPE_ALPHA_EXPLAIN'	=> '密码长度至少 %1$s ，并且包含混合大小写英文字母和数字',
	'PASS_TYPE_ANY_EXPLAIN'		=> '密码长度至少 %1$s ',
	'PASS_TYPE_CASE_EXPLAIN'	=> '密码长度至少 %1$s ，并且包含混合大小写字母',
	'PASS_TYPE_SYMBOL_EXPLAIN'	=> '密码长度至少 %1$s ，并且包含合大小写英文字母和数字及符号',
	'PASSWORD'					=> '密码',
	'PASSWORD_ACTIVATED'		=> '您的新密码已经启用',
	'PASSWORD_RESET'			=> '您的密码已经被成功重置了。',
	'PASSWORD_RESET_LINK_SENT'	=> '如果您的账号存在，一个密码重置链接会发送到你的注册邮箱地址。如果您没有收到任何 Email，它可能有下列原因：您的账号被禁用了，您的账号还没有激活，短期内您要求了太多的密码重置，或者您不被允许修改密码。 如果您有相关问题，请联系管理员。对了，记得查看你的 Email 垃圾邮件过滤设置。',
	...
	'REPORT_PM'							=> '举报短信',
	'RESET_PASSWORD'					=> '重置密码',
	'RESET_TOKEN_EXPIRED_OR_INVALID'	=> '您用的密码充值所需的令牌是无效的，或者已经过期。',
