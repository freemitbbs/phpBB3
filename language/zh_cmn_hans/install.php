...
$lang = array_merge($lang, array(
	...
	'INTRODUCTION_BODY'		=> '欢迎来到phpBB3!<br /><br />phpBB® 是世界上使用最为广泛的开源论坛软件。phpBB3 是自2000年以来这一系列的最新产品。与之前的版本相比，phpBB3 具有更丰富的功能，更友好的操作界面，并拥有 phpBB 团队的完整技术支持。phpBB3 大幅提升了phpBB2 受人欢迎的功能，并且添加了众多用户迫切需要的新特性。我们希望 phpBB3 能超出您的期待.<br /><br />这个安装系统将全程引导您安装，从旧版升级或者转换不同的论坛(包括 phpBB2)到 phpBB3。要获取更多的信息，我们推荐您阅读<a href="%1$s">安装指南</a>。<br /><br />要阅读 phpBB3 许可或了解如何获得支持及我们的立场，请在旁边的菜单中选择。继续下一步操作，请点击上方相应的标签。',

	// Support page
	'SUPPORT_TITLE'		=> '支持',
	'SUPPORT_BODY'		=> '我们将免费为当前发布的 phpBB3 稳定版本提供完全的技术支持。这包括：</p><ul><li>安装</li><li>设置</li><li>技术问题</li><li>与软件中潜在的 Bug 相关的问题</li><li>从先前发布的候选（RC）版本升级至最新稳定版本</li><li>从 phpBB 2.0.x 转换至 phpBB3</li><li>从其他的论坛转换至 phpBB3 (请访问 <a href="https://www.phpbb.com/community/viewforum.php?f=486">转换器论坛</a>)</li></ul><p>我们建议还在使用 phpBB3 Beta 版本的用户立即用最新的版本替换他们的系统.</p><h2>扩展/风格</h2><p>与扩展相关的问题，请发表在相应的 <a href="https://www.phpbb.com/community/viewforum.php?f=451">扩展论坛</a>.<br />与风格，模板和图集相关的问题，请发表在相应的 <a href="https://www.phpbb.com/community/viewforum.php?f=471">风格论坛</a>.<br /><br />如果您的问题与特定的包相关，请直接在相应包的主题后回帖.</p><h2>获得支持</h2><p><a href="https://www.phpbb.com/support/">支持部分</a><br /><a href="https://www.phpbb.com/support/docs/en/3.3/ug/quickstart/">快速开始指南</a><br /><br />为了确保您获得最新版本的相关信息，请关注我们的 <a href="https://www.twitter.com/phpbb/">Twitter</a> 帐号和 <a href="https://www.facebook.com/phpbb/">Facebook</a> 帐号。<br /><br />',
	...
	// Install page
	'INSTALL_INTRO'			=> '欢迎安装！',
	'INSTALL_INTRO_BODY'	=> '使用这个选项，就可以在您的服务器上安装 phpBB3。</p><p>为了继续安装，您需要知道您的数据库设置。如果您不清楚这些，请联络您的主机服务商。没有这些信息安装将不能继续。您需要:</p>
	<ul>
	...
	<p><strong>注意:</strong> 如果您使用 SQLite，您应该在 DSN 栏输入数据库文件的完整路径并留空用户名和密码。基于安全考量， 您应该确保数据库文件不会存放在一个可以被公众访问的文件夹下。</p>

	<p>phpBB3 支持如下的数据库:</p>
	<ul>
		<li>MySQL 4.1.3 或更高 （必须 MySQLi）</li>
...
$lang = array_merge($lang, array(
	...
	'FILE_NOT_EXISTS_EXPLAIN_OPTIONAL'		=> '建议保留 %1$s 文件以获取更好的论坛用户体验。',
	'FILE_NOT_WRITABLE'			=> '文件不可写入',
	...
	'DIRECTORY_NOT_EXISTS_EXPLAIN_OPTIONAL'		=> '建议保留 %1$s 目录以获取更好的论坛用户体验。',
	'DIRECTORY_NOT_WRITABLE'			=> '目录不可写入',
	...
	'PHP_VERSION_REQD_EXPLAIN'			=> 'phpBB 需要 PHP version 7.2.0 以上。',
	...
	'PCRE_UTF_SUPPORT_EXPLAIN'			=> '如果 PHP 的 PCRE 扩展不支持 UTF-8，phpBB 将无法运行。',
	'PHP_JSON_SUPPORT'					=> 'PHP JSON 支持',
	'PHP_JSON_SUPPORT_EXPLAIN'			=> '为了 phpBB 的正常使用， PHP JSON 扩展需要可用。',
	'PHP_MBSTRING_SUPPORT'				=> 'PHP mbstring 支持',
	'PHP_MBSTRING_SUPPORT_EXPLAIN'		=> '为了 phpBB 的正常使用， PHP mbstring 扩展需要可用。',
	'PHP_XML_SUPPORT'					=> 'PHP XML/DOM 支持',
	'PHP_XML_SUPPORT_EXPLAIN'			=> '为了 phpBB 的正常使用， PHP XML/DOM 扩展需要可用。',
	'PHP_SUPPORTED_DB'					=> '支持的数据库',
	'PHP_SUPPORTED_DB_EXPLAIN'			=> '您必须为PHP提供至少一个兼容的数据库。如果下面没有可用的数据库模块，您应该联络服务供应商，或者查阅相关的 PHP 安装文档。',
...
$lang = array_merge($lang, array(
	'INST_ERR_MISSING_DATA'		=> '所有字段都是必填项。',

	'TIMEOUT_DETECTED_TITLE'	=> '安装程序超时',
	'TIMEOUT_DETECTED_MESSAGE'	=> '安装程序超时，您可以尝试着刷新此页，也许会出现数据崩溃。我们建议您增加超时设置值，或者试着用 CLI 方式安装。',
));
...
$lang = array_merge($lang, array(
	...
	'ADMIN_USERNAME_EXPLAIN'	=> '请输入一个 3 到 20 位的用户名。',
	...
	'DB_CONFIG'				=> '数据库设置',
	'DBMS'					=> '数据库类型',
	'DB_HOST'				=> '数据库服务器主机名或 DSN',
	'DB_HOST_EXPLAIN'		=> 'DSN 代表数据源名称，它只用于 ODBC 安装。对于 PostgreSQL，需要用 localhost 连接 UNIX domain socket  或用 127.0.0.1 连接 TCP 上 本地服务器。对于 SQLite，需要输入数据库文件的完整路径。',
	'DB_PORT'				=> '数据库服务器端口',
	...
	'TABLE_PREFIX_EXPLAIN'	=> '前缀必须以字母开始，并只包含英文字母数字和下划线。',
	...
	'INST_ERR_DB_INVALID_PREFIX'	=> '您输入的前缀无效。必须以字母开头并且只包含英文字母、数字和下划线。',
	'INST_ERR_PREFIX_TOO_LONG'		=> '您指定的表格前缀过长，上限为 %d 个字符。',
	'INST_ERR_DB_NO_NAME'			=> '没有指定数据库名称。',
	'INST_ERR_DB_FORUM_PATH'		=> '指定的数据库文件位于论坛目录内，您应该把它放在一个无法通过 web 访问的位置。',
	'INST_ERR_DB_CONNECT'			=> '连接数据库失败，错误信息如下。',
	'INST_ERR_DB_NO_WRITABLE'		=> '数据库以及包含数据库的目录都需要可写。',
	'INST_ERR_DB_NO_ERROR'			=> '没有得到相应的错误信息。',
	'INST_ERR_PREFIX'				=> '已经存在使用指定前缀的表格，请另外指定一个。',
	'INST_ERR_DB_NO_MYSQLI'			=> '服务器内安装的 MySQL 版本与您选择的 “MySQL (使用 MySQLi 扩展)” 选项不兼容，请尝试 “MySQL” 选项。',
	'INST_ERR_DB_NO_SQLITE3'		=> '您安装的 SQLite 扩展版本太旧，必须升级到至少 3.6.15。',
	'INST_ERR_DB_NO_ORACLE'			=> '服务器内安装的 Oracle 版本需要您将参数 <var>NLS_CHARACTERSET</var> 设置为 <var>UTF8</var>。请修改此参数，或将 Oracle 升级至最低 9.2 版。',
	...
	// Email data
	//
	'EMAIL_CONFIG'	=> 'E-mail 设置',

	// Package info
	'PACKAGE_VERSION'					=> '已安装的包版本',
	'UPDATE_INCOMPLETE'				=> '你的 phpBB 程序没有正确的升级。',
	'UPDATE_INCOMPLETE_MORE'		=> '请阅读以下信息，来修正错误。',
	'UPDATE_INCOMPLETE_EXPLAIN'		=> '<h1>不完整的更新</h1>
	...
	//
	// Form labels
	'UPGRADE_INSTRUCTIONS'			=> '新功能的版本 <strong>%1$s</strong> 可用。请阅读  <a href="%2$s" title="%2$s"><strong>the release announcement</strong></a> 来了解相关的信息，以及如何升级。',
	'SERVER_CONFIG'				=> '服务器设置',
	'SCRIPT_PATH'				=> '脚本路径',
	'SCRIPT_PATH_EXPLAIN'		=> 'phpBB 目录与域名间的相对路径，例如：<samp>/phpBB3</samp>。',
...
$lang = array_merge($lang, array(
	...
	'DEFAULT_INSTALL_POST'			=> '<t>这是新安装好的 phpBB3 论坛中的一个样本帖子。您可以删除这个帖子、这个主题甚至这个版面， 因为一切看起来都运转正常！在整个安装过程中，你的第一个分区和第一个版面，都已经给与了适当的权限，预定义的用户组，管理员，蜘蛛，以及总版主，游客，注册用户，注册的 COPPA 用户。如果您选择删除这第一个分区和第一个版面，不要忘记在您新创建的分区和版面，给与用户组适当的权限。我们建议您重命名您的第一个分区和版面，并复制权限到您之后所创建的版面。祝您玩的高兴！</t>',

	'FORUMS_FIRST_CATEGORY'			=> '您的第一个分区',
	'FORUMS_TEST_FORUM_DESC'		=> '您的第一个版面的简单描述',
	'FORUMS_TEST_FORUM_TITLE'		=> '您的第一个版面',

	'RANKS_SITE_ADMIN_TITLE'		=> '网站管理员',
	'REPORT_WAREZ'					=> '此贴包含了非法或盗版软件的链接。',
	'REPORT_SPAM'					=> '此贴的唯一目的是为其它网站或产品做广告。',
	'REPORT_OFF_TOPIC'				=> '此帖跑题了。',
	'REPORT_OTHER'					=> '举报原因没有适用的条目，请填写更多信息。',
...
$lang = array_merge($lang, array(
	...
	'UPDATE_INSTALLATION_EXPLAIN'	=> '本选项将升级您的 phpBB 系统到最新版本。<br />在升级处理期间所有的文件都将被检查是否完整。您在升级前可以查看文件和所有的区别变化。<br /><br />文件自动升级的途径有两条。</p><h2>手动升级</h2><p>这个选项，您只需要下载有改动的文件以确保不会丢失您对其他文件的修改。下载后将文件上载到phpBB目录的相应位置。之后，您可以再次进行文件检查，检查是否将文件放到了正确的位置。</p><h2>通过 FTP 自动升级</h2><p>这个方法和第一个类似，但是不需要下载有变动的文件和手动上传它们。系统将为您自动做这个工作。用这个方法进行升级您需要知道您的 FTP 登录的详细信息。 一旦完成设置，系统将重新定向到文件检查功能以确保系统升级正确。.<br /><br />',
	'UPDATE_INSTRUCTIONS'			=> '
		...
		<br />
		<h1>如何使用完整安装包升级您的论坛</h1>
		<p>推荐的升级方法就是使用完整安装包。如果你所安装的 phpBB 系统中的核心文件曾经被你修改过，你也许想要用进阶升级包来升级，以保留那些你所做的修改。你也可以采用在 INSTALL.html 里所列出的方法来升级。使用 phpBB 3 的完整安装包来升级的步骤是：</p>
		<ol style="margin-left: 20px; font-size: 1.1em;">
			<li><strong class="error">备份所有的论坛文件和数据库。</strong></li>
			<li>到 <a href="https://www.phpbb.com/downloads/" title="https://www.phpbb.com/downloads/">phpBB.com 下载页面</a> 下载最新的 "Full Package" 完整安装压缩包文件。</li>
			<li>解压缩下载的压缩包文件。</li>
			<li><em>从解压后的文件中</em> （不是你的网站），删除 <code class="inline">config.php</code> 文件， 以及下面几个文件夹 <code class="inline">/images</code>， <code class="inline">/store</code> 和 <code class="inline">/files</code> 。 </li>
			<li>登录你的论坛的管理员控制面板 ACP，Board settings 论坛设定，确认使用的默认风格是 prosilver 。</li>
			<li>在你的网站的论坛根目录下，删除 <code class="inline">/vendor</code> 和 <code class="inline">/cache</code> 文件夹。</li>
			<li>通过 FTP 或者 SSH 上传之前处理好的解压后的文件和文件夹到你的论坛的根目录，覆盖原有的文件，（注意：不要删除在你的 <code class="inline">/ext</code> 文件夹下的任何扩展。）</li>
			<li><strong><a href="%1$s" title="%1$s">把浏览器指向你的升级目录，开始升级过程</a>。</strong></li>
			<li>按照步骤升级数据库并且等待完成。</li>
			<li>通过 FTP 或者 SSH 删除 <code class="inline">/install</code> 文件夹。<br><br></li>
		</ol>
		
		<p>现在你就拥有了一个全新升级的论坛，并保留了你原有的用户和帖子。 后续的任务：</p>
		...
		<h1>如何使用进阶升级包升级您的论坛</h1>
		<p>进阶升级包只推荐给专业用户使用，且当 phpBB 的核心文件曾经被修改过的情况下，才。您也可以采用 INSTALL.html 文档中列出的方式升级。进阶升级 phpBB3 的步骤是：</p>

		<ol style="margin-left: 20px; font-size: 1.1em;">
			<li>到 <a href="https://www.phpbb.com/downloads/" title="https://www.phpbb.com/downloads/">phpBB.com 下载页</a>下载 "Advanced Update Package"。<br /><br /></li>
			<li>解压缩档案.<br /><br /></li>
			<li>上传解压完的 "install" 和 "vendor" 文件夹到您的 phpBB 根目录(config.php文件所在目录)。<br /><br /></li>
		</ol>

		<p>一旦上传普通用户将无法访问论坛，因为有 install 目录存在。<br /><br />
		<strong><a href="%1$s" title="%1$s">现在输入 install 地址开始更新程序</a>。</strong><br />
		<br />
...
$lang = array_merge($lang, array(
	...
	'UPDATE_FILE_METHOD_DOWNLOAD'	=> '下载修改过后的压缩文件包',
...
$lang = array_merge($lang, array(
	...
	'NO_UPDATE_FILES_UP_TO_DATE'	=> '您已经是最新版本了。无需再运行升级工具。如果您想对文件做完整性检测，请确认上传了正确的升级文件。',
...
$lang = array_merge($lang, array(
	...
	'DOWNLOAD_UPDATE_METHOD_EXPLAIN'	=> '当您下载并解压缩文件包后，您需要上传所有的解压后的文件到 phpBB 安装目录。请上传文件到对应的位置。当您完成所有文件的上传后，请继续升级。',
	...
	'FILES_NOT_MODIFIED_EXPLAIN'	=> '下面的文件在老版本的 phpBB 文件有，在新版本中也没有修改。',
...
$lang = array_merge($lang, array(
	...
	'DEV_NO_TEST_FILE'			=> '在转换器中没有指定 test_file 变量的值。如果您是转换器的使用者，您不应该看到这个错误，请联络转换器的作者并报告这个错误。如果您是转换器的作者，您必须指定一个源论坛中存在的文件名称，使得路径校验能正常进行。',
	...
	'CONTINUE_OLD_CONVERSION'	=> '继续上一次的转换',
	'POST_ID'					=> '帖子 ID',
	...
	'CONVERT_COMPLETE_EXPLAIN'	=> '您已经将您的论坛成功转换为 phpBB 3.3，您现在可以登录并<a href="../">访问您的论坛</a>。请在开启新论坛前确认参数都已经正确设置，并删除了install安装目录。别忘了phpBB 的在线使用帮助有<a href="https://www.phpbb.com/support/docs/en/3.3/ug/">文档</a>和<a href="https://www.phpbb.com/community/viewforum.php?f=661">支持论坛</a>。',

	'COLLIDING_CLEAN_USERNAME'			=> '<strong>%s</strong> 是清洁的用户名：',
	'COLLIDING_USER'					=> '» 用户 id：<strong>%d</strong> 用户名：<strong>%s</strong> (%d posts)',
	'COLLIDING_USERNAMES_FOUND'			=> '在你的旧论坛有冲突的用户名。为了完成转换，请删除或者重命名这些用户，这样保证每个清洁用户名只有一个用户使用。',
	'CONV_ERR_FATAL'					=> '致命转换错误',
	'CONV_ERROR_ATTACH_FTP_DIR'			=> '原论坛允许附件使用 FTP 上载，请禁用 FTP 上载并确认设定了有效的上载目录，所有附件将被拷贝到这个新的 web 可访问的目录。这些完成后，请重新开始转换程序。',
	...
	'CONV_ERROR_INCONSISTENT_GROUPS'	=> '在 add_bots() 中检测到用户组表单中的矛盾数据 - 如果手工设置过您需要添加所有特殊用户组。',
	'CONV_ERROR_INSERT_BOT'				=> '无法在用户表中添加 bot。',
	'CONV_ERROR_INSERT_BOTGROUP'		=> '无法在 bots 表中添加 bot。',
