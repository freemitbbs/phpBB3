...
$lang = array_merge($lang, array(
	...
	'ACCOUNT_DEACTIVATED'			=> '您的帐号已经被停用，并且只有管理员才能重新激活。',
	'ACP'							=> '管理员控制面板',
	'ACP_SHORT'						=> 'ACP',
	'ACTIVATION_ALREADY_SENT'		=> '激活电子邮件已经发送到你的邮箱，你可以24小时后再尝试。如果你持续遇到账号激活问题，请联系坛管理员。',
	'ACTIVE'						=> '激活',
	...
	'ALT_TEXT'						=> '替换文本',	
	'AND'							=> '和',
	'ARE_WATCHING_FORUM'			=> '您订阅了这个版面，版面有新帖子时将向您发送消息。',
	'ARE_WATCHING_TOPIC'			=> '您订阅了这个主题，主题有新回帖时将向您发送消息。',
	'ASCENDING'						=> '升序',
	'ATTACHMENTS'					=> '附件',
	'ATTACHED_IMAGE_NOT_IMAGE'		=> '您附加的图片文件是无效的。',
	'AUTHOR'						=> '作者',
	'AUTH_NO_PROFILE_CREATED'		=> '创建用户资料失败',
	'AUTH_PROVIDER_OAUTH_ERROR_ALREADY_LINKED'				=> '此外部服务已经同其它论坛账号相连接了。',
	'AUTH_PROVIDER_OAUTH_ERROR_INVALID_ENTRY'				=> '无效的数据库记录。',
	'AUTH_PROVIDER_OAUTH_ERROR_INVALID_SERVICE_TYPE'		=> '提供给 OAuth 服务处理程序的是无效的服务类型。',
	'AUTH_PROVIDER_OAUTH_ERROR_REQUEST'						=> '在处理您的 OAuth 请求时出现了某个错误。',
	'AUTH_PROVIDER_OAUTH_RETURN_ERROR'						=> '外部服务返回了错误值，所以您的请求无法继续。',
	...
	'AVATAR_NO_TEMP_DIR'			=> '无法找到临时目录，或者不可写入。',	
	'AVATAR_NO_SIZE'				=> '无法自动获取头像的长和宽，请手动输入合适的数值。',
	'AVATAR_NO_UPLOAD_DIR'			=> '头像储存路径不存在或者不可写入。',
	'AVATAR_NO_UPLOAD_PATH'			=> '头像上传启用了，但是头像储存路径尚未设置。',
	...
	'AVATAR_WRONG_SIZE'				=> '提交的头像宽 %5$s 高 %6$s。头像应至少宽 %1$s 高 %2$s，但不能超过宽 %3$s 高 %4$s。',
	...
	'CHANGING_PREFERENCES'	=> '更改论坛偏好',
	'CHANGING_PROFILE'		=> '更改资料设置',
	'CHARACTERS'			=> array(
		1	=> '%d 字符',
	),
	...
	'CONFIRM'				=> '确认',
	'CONFIRM_CODE'			=> '确认码',
	'CONFIRM_CODE_EXPLAIN'	=> '输入您在图片中看到的字符，不必区分大小写。',
	...
	'DISPLAY_POSTS'			=> '显示帖子 ',
	'DISPLAY_TOPICS'		=> '显示主题 ',
	'DOMAIN_NO_MX_RECORD_EMAIL'	=> '输入的 email 地址域名没有有效的 MX 记录。',
	'DOWNLOADED'			=> '已下载',
	...
	'ERR_JAB_AUTH'						=> '无法通过 Jabber 服务器验证。',
	'ERR_JAB_CONNECT'					=> '无法连接到 Jabber 服务器。',
	'ERR_UNABLE_TO_LOGIN'				=> '输入的用户名或密码不正确。',
	...
	'FROM'					=> '从',
	'FSOCK_DISABLED'		=> '操作无法完成，因为 <var>fsockopen</var> 函数被禁用或者无法找到目标服务器。',
	'FSOCK_TIMEOUT'			=> '读取网络流时发生超时错误。',

	'FILESYSTEM_CANNOT_CHANGE_FILE_GROUP'		=> '无法改变文件组',
	'FILESYSTEM_CANNOT_CHANGE_FILE_PERMISSIONS'	=> '无法改变文件权限',
	'FILESYSTEM_CANNOT_COPY_FILES'				=> '无法复制文件',
	'FILESYSTEM_CANNOT_CREATE_SYMLINK'			=> '无法新建符号链接',
	'FILESYSTEM_CANNOT_CREATE_DIRECTORY'		=> '无法新建目录',
	'FILESYSTEM_CANNOT_DELETE_FILES'			=> '无法从系统删除文件',
	'FILESYSTEM_CANNOT_DUMP_FILE'				=> '无法转储到文件',
	'FILESYSTEM_CANNOT_MIRROR_DIRECTORY'		=> '无法镜像目录',
	'FILESYSTEM_CANNOT_RENAME_FILE'				=> '无法重命名一个文件',
	'FILESYSTEM_CANNOT_TOUCH_FILES'				=> '无法创建文件或者修改文件的时间戳',
    ...
    'GIB'                       => 'GiB',
	'GO'						=> '执行',
	'GOTO_FIRST_POST'			=> '到第一个帖子',
	'GOTO_LAST_POST'			=> '到最后一个贴子',
	'GOTO_PAGE'					=> '前往页数',
	'GROUP'						=> '用户组',
	'GROUPS'					=> '用户组',
	...
	'HOURS'						=> '小时',
	'HOME'						=> '首页',
	'HTTP_HANDLER_NOT_FOUND'	=> '因为禁用了 cURL PHP 扩展以及 PHP 的 ini 设置中的 allow_url_fopen，也没有其它 HTTP 处理程序，此操作无法完成。',
	...
	'LOGIN_ERROR_ATTEMPTS'				=> '您超出了论坛规定的最大尝试次数。除了您的用户名和密码外您还需要通过 Captcha 检测。',
	'LOGIN_ERROR_EXTERNAL_AUTH_APACHE'	=> '您未获 Apache 服务器授权。',
	...
	'NOT_ALLOWED_MANAGE_GROUP'	=> '您不能管理这个用户组。',
	'NOT_AUTHORISED'			=> '您没有访问这个区域的权限。',
	'NOT_WATCHING_FORUM'		=> '您不再订阅这个版面的更新消息。',
	'NOT_WATCHING_TOPIC'		=> '您不再订阅这个主题。',
	'NOTIFICATIONS'				=> '通知',
	...
	'NOTIFICATION_POST_IN_QUEUE'		=> '<strong>帖子审核</strong>请求来自 %1$s：',
	...
	'NOTIFICATION_REPORT_PM_CLOSED'		=> '<strong>站内短信举报</strong> 由 %1$s 关闭:',
	...
	'NOTIFICATION_TOPIC_IN_QUEUE'		=> '<strong>主题审核</strong>请求由 %1$s：',
	'NOTIFICATION_TYPE_NOT_EXIST'		=> '通知类型 "%s" 从文件系统丢失。',
	'NOTIFICATION_ADMIN_ACTIVATE_USER'	=> '<strong>激活请求</strong>来自于新注册或被停用的用户: “%1$s”',
	...
	'NO_ACCESS_ATTACHMENT'		=> '您不能访问这个文件。',
	'NO_ACTION'					=> '没有指定操作。',
	...
	'NO_FEED_ENABLED'			=> '聚合供稿 Feed 尚未启用。',
	'NO_FEED'					=> '请求的 聚合供稿 Feed 无效。',
	'NO_STYLE_DATA'				=> '无法获得用户样式 %s 的样式数据，并应用于用户id %s',
	...
	'NO_SUCH_SEARCH_MODULE'		=> '指定的搜索后端不存在。',
	...
	'POST_UNAPPROVED_EXPLAIN'	=> '这个帖子只有在版主审核通过后，才会显示给其他用户看。',
	'POWERED_BY'			=> '由 %s 提供支持',
	...
	'ROUTE_NOT_FOUND'				=> '请求的路由  “%s” 找不到。',
	'ROUTE_INVALID_MISSING_PARAMS'	=> '无效或者缺少参数的 “%s” 路由。',
	'FEED'						=> 'Feed',
	'FEED_NEWS'					=> '新帖子',
	'FEED_TOPICS_ACTIVE'		=> '活跃主题',
	'FEED_TOPICS_NEW'			=> '新主题',
	'RULES_ATTACH_CAN'			=> '您 <strong>可以</strong> 在这个版面发布附件',
	'RULES_ATTACH_CANNOT'		=> '您 <strong>不能</strong> 在这个版面发布附件',
