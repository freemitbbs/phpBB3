...
$lang = array_merge($lang, array(
	...
	'ACL_U_SIG'			=> '可以使用签名档',
	'ACL_U_EMOJI'		=> '可以在主题标题中使用 emoji 和富文字字符',
	...
	'ACL_U_VIEWONLINE'	=> '可以查看隐藏在线状态的用户',
	'ACL_U_SEARCH'		=> '可以搜索论坛',
));
...
$lang = array_merge($lang, array(
	...
	'ACL_F_POLL'		=> '可以创建投票',
	'ACL_F_VOTE'		=> '可以参与投票',
	'ACL_F_VOTECHG'		=> '可以更改现有的投票',
));

// Moderator Permissions
$lang = array_merge($lang, array(
	'ACL_M_EDIT'		=> '可以编辑帖子',
	'ACL_M_DELETE'		=> '可以永久删除帖子',
	'ACL_M_SOFTDELETE'		=> '可以软删除帖子<br /><em>拥有审阅帖子权限的版主，可以恢复软删除的帖子。</em>',
