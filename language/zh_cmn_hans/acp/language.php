...
$lang = array_merge($lang, array(
	'ACP_FILES'						=> '管理语言文件',
	'ACP_LANGUAGE_PACKS_EXPLAIN'	=> '这里您可以安装/删除语言包，默认的语言包用星号标记。',

	'DELETE_LANGUAGE_CONFIRM'		=> '您确定要删除 “%s” 吗？',

	'INSTALLED_LANGUAGE_PACKS'	=> '已安装的语言包',

	'LANGUAGE_DETAILS_UPDATED'			=> '语言细节更新完成。',
	'LANGUAGE_PACK_ALREADY_INSTALLED'	=> '这个语言包已经安装过了。',
	'LANGUAGE_PACK_DELETED'				=> ' %s 语言包已被成功删除。 所有使用此语言的用户将被重置到论坛默认语言。',
	'LANGUAGE_PACK_DETAILS'				=> '语言包细节',
	'LANGUAGE_PACK_INSTALLED'			=> ' %s 语言包安装完成。',
	'LANGUAGE_PACK_CPF_UPDATE'			=> '自定义资料的栏目的会使用默认的语言。如果需要请修改它们。',
	...
	'MISSING_LANG_FILES'		=> '缺少的语言文件',
	'MISSING_LANG_VARIABLES'	=> '缺少的语言变量',
	...
	'THOSE_MISSING_LANG_VARIABLES'		=> '在 %s 语言包中缺少如下语言变量',
