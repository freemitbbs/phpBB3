...
$lang = array_merge($lang, array(
	...
	'AT_LEAST_ONE_FOUNDER'	=> '您不能将此创始人设置为普通用户。这个论坛至少需要一名创始人。如果您需要改变这个用户的等级，请先提升另一位用户为创始人。',

	'BAN_ALREADY_ENTERED'	=> '已经封禁过，封禁列表没有更新。',
	'BAN_SUCCESSFUL'		=> '封禁输入完成。',

	'CANNOT_BAN_ANONYMOUS'         	=> '您不能封禁游客帐号。游客权限可以在权限控制界面修改。',
	'CANNOT_BAN_FOUNDER'			=> '您不能封禁创始人帐号。',
	'CANNOT_BAN_YOURSELF'			=> '您不能封禁自己的帐号。',
	'CANNOT_DEACTIVATE_BOT'			=> '您不能停用机器人帐号，如果需要停用，请到爬虫/机器人管理页面。',
	'CANNOT_DEACTIVATE_FOUNDER'		=> '您不能停用创始人帐号。',
	'CANNOT_DEACTIVATE_YOURSELF'	=> '您不能停用自己的帐号。',
	'CANNOT_FORCE_REACT_BOT'		=> '您不能强制激活机器人帐号，如果需要启用，请到爬虫/机器人管理页面。',
	'CANNOT_FORCE_REACT_FOUNDER'	=> '您不能强制激活创始人帐号。',
	'CANNOT_FORCE_REACT_YOURSELF'	=> '您不能强制激活自己的帐号。',
	'CANNOT_REMOVE_ANONYMOUS'		=> '您不能删除游客帐号。',
	'CANNOT_REMOVE_FOUNDER'			=> '您不能删除创始人账户。',
	'CANNOT_REMOVE_YOURSELF'		=> '您不能删除自己的帐号。',
	'CANNOT_SET_FOUNDER_IGNORED'	=> '您不能提升被忽略的用户为创始人。',
	'CANNOT_SET_FOUNDER_INACTIVE'	=> '您需要先激活用户才能提升他们为创始人，只有被激活的用户才能被提升。',
	'CONFIRM_EMAIL_EXPLAIN'			=> '您只有在改变用户 email 地址的时候才需要指定这个。',

	'DELETE_POSTS'			=> '删除帖子',
	'DELETE_USER'			=> '删除用户',
	'DELETE_USER_EXPLAIN'	=> '请注意删除的用户不可恢复,此用户发送的私信即使未被读取也将被删除。',

	'FORCE_REACTIVATION_SUCCESS'	=> '强制激活完成。',
	'FOUNDER'						=> '创始人',
	'FOUNDER_EXPLAIN'				=> '创始人拥有管理员的所有权限，并且不能被非创始人封禁、删除和更改',
	...
	'NO_WARNINGS'			=> '没有警告.',
	'NOT_MANAGE_FOUNDER'	=> '您在尝试使管理创始人用户。只有创始人才可以管理其他创始人用户。',
	...
	'USER_ADMIN_BAN_EMAIL'			=> '根据 email 封禁',
	'USER_ADMIN_BAN_EMAIL_REASON'	=> '在用户管理中封禁了的 email 地址',
	'USER_ADMIN_BAN_IP'				=> '根据 IP 封禁',
	'USER_ADMIN_BAN_IP_REASON'		=> '在用户管理中封禁了的 IP 地址',
	'USER_ADMIN_BAN_NAME_REASON'	=> '在用户管理中封禁了的用户名',
	'USER_ADMIN_BAN_USER'			=> '根据用户名封禁',
	'USER_ADMIN_DEACTIVATE'			=> '停用帐号',
	'USER_ADMIN_DEACTIVED'			=> '帐号停用成功。',
	...
	'USER_CUSTOM_PROFILE_FIELDS'	=> '自定义个人资料字段',
	'USER_DELETED'					=> '用户已经删除。',
	'USER_GROUP_ADD'				=> '添加用户到组',
	'USER_GROUP_NORMAL'				=> '用户设置的用户组之成员',
	'USER_GROUP_PENDING'			=> '等待批准的用户组',
	'USER_GROUP_SPECIAL'			=> '系统预设的用户组之成员', 
	'USER_LIFTED_NR'				=> '成功移除此用户的新用户状态。',
	...
	'USER_POSTS_MOVED'				=> '已经移动用户的帖子到目标版面。',
	'USER_PREFS_UPDATED'			=> '用户偏好设置已更新。',
	'USER_PROFILE'					=> '用户资料',
