...
$lang = array_merge($lang, array(
	'ACP_GROUPS_MANAGE_EXPLAIN'		=> '在这个面板您可以管理所有的用户组。您可以删除、创建和编辑现有的用户组。此外，您还可以选择组领导，在开放、隐藏或封闭三种组状态之间切换，以及设置组名称与描述。',
	...
	'GROUP_CREATED'					=> '用户组创建成功。',
	'GROUP_DEFAULT'					=> '设置为成员的默认组',
	'GROUP_DEFS_UPDATED'			=> '设置为选中成员的默认组。',
	'GROUP_DELETE'					=> '从用户组中删除成员',
	'GROUP_DELETED'					=> '组已经删除并且用户默认组设置完成。',
	'GROUP_DEMOTE'					=> '从组领导降级',
	'GROUP_DESC'					=> '用户组描述',
	'GROUP_DETAILS'					=> '用户组细节',
	'GROUP_EDIT_EXPLAIN'			=> '这里您可以编辑现有的用户组。更改名称，描述和类型 (开放，封闭等)。您还可以设置一些用户组范围的选项例如颜色，等级。更改将覆盖用户的当前设置。请注意组成员可以更改他们的头像，除非您设置了相关的权限。',
	...
	'GROUP_USERS_INVALID'			=> '因为用户名  %s 不存在，所以添加用户到用户组的操作不成功。',
	...
	'USER_DEF_GROUPS_EXPLAIN'		=> '这些用户组由您或者其他管理员创建。您可以管理成员和编辑其属性或者删除它。',
