...
$lang = array_merge($lang, array(
	'ACP_MODULE_MANAGEMENT_EXPLAIN'	=> '这里您可以管理各种模块。请注意管理员控制面板使用的是三层菜单结构 (分类 -> 分类 -> 模块) 而其他使用的是两层菜单结构 (分类 -> 模块)。请同样注意的是您有可能会把自己给锁在模块外面，如果您删除或禁用了涉及模块管理的模块。',
	'ADD_MODULE'					=> '添加模块',
	...
	'MODULE_LANGNAME_EXPLAIN'	=> '输入显示的模块名称。如果名称由语言文件提供请使用语言常数。',
	'MODULE_TYPE'				=> '模块类型',
