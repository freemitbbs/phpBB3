...
$lang = array_merge($lang, array(
	...
	'DEFAULT_DATE_FORMAT_EXPLAIN'	=> '日期格式写法和 PHP 的 <a href="https://www.php.net/manual/datetime.format.php">date 函数</a>相同 。',
	...
	'DISPLAY_UNAPPROVED_POSTS'		=> '显示尚未批准发布的贴子给其作者',
	'DISPLAY_UNAPPROVED_POSTS_EXPLAIN'	=> '尚未被批准发布的贴子可以被其作者查看，这并不包括游客发布的贴子。',
	'GUEST_STYLE'					=> '游客风格',
	'GUEST_STYLE_EXPLAIN'			=> '游客专用风格。',
...
$lang = array_merge($lang, array(
	...
	'ALLOW_SIG'					=> '允许签名档',
	'ALLOW_SIG_BBCODE'			=> '在签名档中允许使用 BBCode',
...
$lang = array_merge($lang, array(
	...
	'ALLOW_LOCAL'					=> '允许使用系统头像',
	'ALLOW_REMOTE'					=> '允许使用外部头像',
	'ALLOW_REMOTE_EXPLAIN'			=> '从其它网站链接的头像。<br><em><strong class="error">警告：</strong> 启用此功能可让用户检查是否存在只能在本地网络访问的文件和服务。</em>',
	'ALLOW_REMOTE_UPLOAD'			=> '允许远程上传头像',
	'ALLOW_REMOTE_UPLOAD_EXPLAIN'	=> '允许会员上传来自另一个网站的头像。<br><em><strong class="error">警告：</strong> 启用此功能可让用户检查是否存在只能在本地网络访问的文件和服务。</em>',
	'ALLOW_UPLOAD'					=> '允许头像上传',
	'AVATAR_GALLERY_PATH'			=> '系统头像册路径',
	'AVATAR_GALLERY_PATH_EXPLAIN'	=> '在您的 phpBB 论坛根目录下的预先放置的头像册的路径，例如 <samp>images/avatars/gallery</samp>。<br>双点号，比如<samp>../</samp> 会被自动过滤，以免安全隐患。',
...
$lang = array_merge($lang, array(
	...
	'ALLOW_POST_LINKS_EXPLAIN'			=> '如果禁用，<code>[URL]</code> 标签将停止链接解析。',
	'ALLOWED_SCHEMES_LINKS'				=> '链接中允许使用的协议列表',
	'ALLOWED_SCHEMES_LINKS_EXPLAIN'		=> '用户只能使用无协议头的网址，或者是逗号分隔的允许列表中的一个。',
	...
	'BUMP_INTERVAL'					=> '顶帖间隔',
	'BUMP_INTERVAL_EXPLAIN'			=> '主题中最后一个帖子发表到可以顶帖之间的分钟数、小时数或者天数， 设定为 0 则关闭顶贴功能。',
	...
	'DISPLAY_LAST_EDITED_EXPLAIN'	=> '选择是否在帖子上显示最后修改的信息。',
	'EDIT_TIME'						=> '编辑时限',
	'EDIT_TIME_EXPLAIN'				=> '新帖子在多长时间内可编辑。设置为 0 则不作限制。',
	'FLOOD_INTERVAL'				=> '灌水间隔',
	'FLOOD_INTERVAL_EXPLAIN'		=> '新帖子发表之间的等待秒数。要让用户不受此限制，请修改其权限。',
	'HOT_THRESHOLD'					=> '热门主题的回复数量',
	'HOT_THRESHOLD_EXPLAIN'			=> '成为热门主题需要的最小回复数，设置为 0 则取消热帖功能。',
	'MAX_POLL_OPTIONS'				=> '投票的最大选项数',
	'MAX_POST_FONT_SIZE'			=> '帖子中可以使用的最大字体',
	'MAX_POST_FONT_SIZE_EXPLAIN'	=> '设置为 0 则不作限制。',
	'MAX_POST_IMG_HEIGHT'			=> '帖子中允许的最大 flash 高度',
	'MAX_POST_IMG_HEIGHT_EXPLAIN'	=> '作用于 flash，设置为 0 则不作限制。',
	'MAX_POST_IMG_WIDTH'			=> '帖子中允许的最大 flash 宽度',
	'MAX_POST_IMG_WIDTH_EXPLAIN'	=> '作用于 flash，设置为 0 则不作限制。',
...
$lang = array_merge($lang, array(
	...
	'ACC_ACTIVATION'			=> '帐号激活',
	'ACC_ACTIVATION_EXPLAIN'	=> '这决定了用户在访问论坛之前是否需要确认。您也可以完全关闭新用户注册。<em>要使用用户或管理员激活功能，论坛邮件功能必须开启。</em>',
	'ACC_ACTIVATION_WARNING'		=> '注意，目前选择的用户帐号激活方式需要启用“允许论坛发送 Email”，否则注册将被停用。建议您选择其它的帐号激活方法或者重新启用“允许论坛发送 Email”。',
	'NEW_MEMBER_POST_LIMIT'			=> '新用户发帖数目限制',
	'NEW_MEMBER_POST_LIMIT_EXPLAIN'	=> '新用户会被归入 <em>新注册用户</em> 组直到其发表此数量的帖子。您可以使用此用户组的组权限来限制其使用站内短信以及方便发文审核。<strong>设置为0则不启用此项功能。</strong>',
...
// Feeds
$lang = array_merge($lang, array(
	'ACP_FEED_MANAGEMENT'				=> '通用聚合供稿设置',
	'ACP_FEED_MANAGEMENT_EXPLAIN'		=> '此模块提供多种 ATOM 供稿（ATOM Feeds）， 并转换 BBCode 给外部供稿为可阅读的内容。',

	'ACP_FEED_GENERAL'					=> '综合设定',
	'ACP_FEED_POST_BASED'				=> '基于帖子的供稿设定',
	'ACP_FEED_TOPIC_BASED'				=> '基于主题的供稿设定',
	'ACP_FEED_SETTINGS_OTHER'			=> '其它供稿设定',

	'ACP_FEED_ENABLE'					=> '启用供稿',
	'ACP_FEED_ENABLE_EXPLAIN'			=> '对整个论坛启用或停止 ATOM 供稿。<br>关闭此选项会关闭论坛的所有 ATOM 供稿输出，以下的选项将不再起作用。',
	'ACP_FEED_LIMIT'					=> '条目数量',
	'ACP_FEED_LIMIT_EXPLAIN'			=> '供稿输出条目的最大数量。',

	'ACP_FEED_OVERALL'					=> '启用整个论坛的供稿输出',
	'ACP_FEED_OVERALL_EXPLAIN'			=> '整个论坛的新帖。',
	'ACP_FEED_FORUM'					=> '启用单个版面供稿输出',
	'ACP_FEED_FORUM_EXPLAIN'			=> '单个版面和子版面的最新文章。',
	'ACP_FEED_TOPIC'					=> '启用单个话题供稿输出',
	'ACP_FEED_TOPIC_EXPLAIN'			=> '单个话题的最新文章.',

	'ACP_FEED_TOPICS_NEW'				=> '启用新话题供稿输出',
	'ACP_FEED_TOPICS_NEW_EXPLAIN'		=> '“最新话题”供稿输出最近发表的话题及其第一篇文章的内容。',
	'ACP_FEED_TOPICS_ACTIVE'			=> '启用活跃话题供稿输出',
	'ACP_FEED_TOPICS_ACTIVE_EXPLAIN'	=> '“活跃话题”供稿输出最近发表的活跃话题及其最后一篇回复的内容。',
	'ACP_FEED_NEWS'						=> '各版面最新文章供稿输出',
	'ACP_FEED_NEWS_EXPLAIN'				=> '从以下版面中各摘取最新的一篇文章。如果无指定版面则关闭此项输出。<br>要选定或反选多个版面，请按住<samp>CTRL</samp>键用鼠标左键点选。',

	'ACP_FEED_OVERALL_FORUMS'			=> '启用版面供稿输出',
...
$lang = array_merge($lang, array(
	'ACP_VC_SETTINGS_EXPLAIN'				=> '这里您可以选择和配置插件，以阻止垃圾机器人对论坛的自动表单提交。这些插件通常是对用户提出 <em>CAPTCHA</em> 来工作，这是一种设计上让计算机难以解决的测试。',
	'ACP_VC_EXT_GET_MORE'					=> '更多(可能更好)反垃圾插件，访问 <a href="https://www.phpbb.com/go/anti-spam-ext"><strong>phpBB.com扩展数据库</strong></a>。更多防止论坛垃圾的信息，访问 <a href="https://www.phpbb.com/go/anti-spam"><strong>phpBB.com知识库</strong></a>。',
	'AVAILABLE_CAPTCHAS'					=> '可用插件',
	'CAPTCHA_UNAVAILABLE'					=> '此插件因为不满足必要条件而无法选用。',
	'CAPTCHA_GD'							=> 'GD 验证图片',
	'CAPTCHA_GD_3D'							=> 'GD 3D 验证图片',
	'CAPTCHA_GD_FOREGROUND_NOISE'			=> '前景噪点',
	'CAPTCHA_GD_EXPLAIN'					=> '使用 GD 生成更高级的验证图片。',
	'CAPTCHA_GD_FOREGROUND_NOISE_EXPLAIN'	=> '使用前景噪点令图片更难解读。',
	'CAPTCHA_GD_X_GRID'						=> 'X 轴背景噪点',
	'CAPTCHA_GD_X_GRID_EXPLAIN'				=> '设置越小，越难辨别。 0 将禁用 X 轴的背景噪点。',
	'CAPTCHA_GD_Y_GRID'						=> 'Y 轴背景噪点',
	...
	'CAPTCHA_NO_GD'							=> '简单图片',
	'CAPTCHA_PREVIEW_MSG'					=> '您的修改尚未保存，这只是预览。',
	'CAPTCHA_PREVIEW_EXPLAIN'				=> '当前设定下的预览。',

	'CAPTCHA_SELECT'						=> '安装的插件',
	'CAPTCHA_SELECT_EXPLAIN'				=> '下拉菜单显示被论坛识别的可用验证图片插件。灰色项不能即刻使用，需要先配置后方可使用的插件。',
	'CAPTCHA_CONFIGURE'						=> '配置插件',
	'CAPTCHA_CONFIGURE_EXPLAIN'				=> '修改选中的插件设置。',
	'CONFIGURE'								=> '配置',
	'CAPTCHA_NO_OPTIONS'					=> '此插件没有可设置的选项。',

	'VISUAL_CONFIRM_POST'					=> '游客发文启用反垃圾机器人机制',
	'VISUAL_CONFIRM_POST_EXPLAIN'			=> '当匿名用户发表文章时会被要求通过反垃圾机器人任务，以防自动发布消息。',
	'VISUAL_CONFIRM_REG'					=> '会员注册时启用反垃圾机器人机制',
	'VISUAL_CONFIRM_REG_EXPLAIN'			=> '在新会员注册时会被要求通过反垃圾机器人任务，以防止机器人注册。',
	'VISUAL_CONFIRM_REFRESH'				=> '允许用户刷新反垃圾机器人任务',
	'VISUAL_CONFIRM_REFRESH_EXPLAIN'		=> '当用户无法通过反垃圾机器人任务时，允许其刷新。一些插件可能不支持这个选项。',
));
...
// Contact Settings
$lang = array_merge($lang, array(
	'ACP_CONTACT_SETTINGS_EXPLAIN'		=> '这里您可以启用或禁用联系页面，也可以添加文本显示在联系页面。',
...
$lang = array_merge($lang, array(
	...
	'ALLOW_CDN_EXPLAIN'				=> '如果此设置启用，一些文件将被第三方外部服务器提供，而不是您的服务器。这降低了网络带宽需求，但可能在某些国家存在隐私问题。默认 phpBB 安装时这个包括从 Google 的 CDN 加载 “jQuery” 库 和 “Open Sans” 字体，以及 phpBB 和某些扩展用于渲染图标的 “Font Awesome” 字体文件。',
	'ALLOW_LIVE_SEARCHES'			=> '允许实时搜索',
	'ALLOW_LIVE_SEARCHES_EXPLAIN'	=> '如果此设置启用，用户输入时可看到关键词提示。',
	'CUSTOM_PROFILE_FIELDS'			=> '自定义用户资料',
	'LIMIT_LOAD'					=> '系统负载限制',
	'LIMIT_LOAD_EXPLAIN'			=> '如果系统一分钟内的平均负载超过这个值论坛将自动关闭。值 1.0 等于单颗处理器的100%使用率，这只工作于基于 UNIX 的系统，并且可以得到使用率信息。当论坛程序无法获得负载率的时候，会被重置为 0。',
	...
	'LOAD_USER_ACTIVITY_LIMIT'		=> '用户活跃帖子的限制',
...
$lang = array_merge($lang, array(
	...
	'APACHE_SETUP_BEFORE_USE'	=> '您必须在转换到这种认证模式前建立 apache 认证功能。记住您用于 apache 认证的用户名必须和 phpBB 的用户名相同。Apache 认证只能用于 mod_php 模式。',
...
$lang = array_merge($lang, array(
	...
	'ENABLE_GZIP_EXPLAIN'		=> '生成的页面将在发送给用户前被压缩。这将减少网络流量但是会增加服务器和客户端的 CPU 负载。需要 zlib PHP 扩展 支持。',
	...
	'SERVER_NAME'				=> '域名',
	'SERVER_NAME_EXPLAIN'		=> '论坛所在域名 (例如： <samp>example.com</samp>)。',
	'SERVER_PORT'				=> '服务器端口',
	'SERVER_PORT_EXPLAIN'		=> '服务器运行的端口，通常是 80。只有在不同的情况下才修改。',
	...
	'USE_SYSTEM_CRON'			=> '从操作系统计划任务 cron 运行定期任务',
...
$lang = array_merge($lang, array(
	...
	'EMAIL_MAX_CHUNK_SIZE'			=> '最多允许的收件人数',
	'EMAIL_MAX_CHUNK_SIZE_EXPLAIN'	=> '如果必要的话，设置此值为不超过您的电邮服务器所允许的单个邮件的最多收件人数。',
	'EMAIL_SIG'						=> 'Email 签名',
	...
	'SMTP_SERVER_EXPLAIN'			=> '不要提供服务器所使用的协议，除非你的邮件服务商告知你这么做，请用此种格式：<samp>ssl://</samp> or <samp>tls://</samp>。',
