...
$lang = array_merge($lang, array(
	...
	'ACP_CONTACT'				=> '联系页',
	'ACP_CONTACT_SETTINGS'		=> '联系页设定',
	'ACP_CRITICAL_LOGS'			=> '错误日志',
	'ACP_CUSTOM_PROFILE_FIELDS'	=> '自定义资料字段',
	...
	'CSV_INVALID'			=> '此以逗号分隔的设置 “%1$s” 无效。 设置值应当只有逗号分隔，且不含任何前导或尾部的分隔符。',
	...
	'UCP'					=> '用户控制面板',
	'URL_INVALID'			=> '设置的 URL “%1$s” 无效。',
	'URL_SCHEME_INVALID'	=> '以逗号分隔的设置 “%1$s” 中提供的协议 “%2$s” 无效。. 协议应当以拉丁文字母开头，后面是字母数字或者连字符和点。 ',
...
$lang = array_merge($lang, array(
	...
	'ERROR_MBSTRING_HTTP_INPUT_EXPLAIN'				=> '<var>mbstring.http_input</var>必须留空。您可以在 <samp>PHP信息</samp>页检查当前值。',
	'ERROR_MBSTRING_HTTP_OUTPUT'					=> 'HTTP 输出字符转换配置错误',
	'ERROR_MBSTRING_HTTP_OUTPUT_EXPLAIN'			=> '<var>mbstring.http_output</var>必须留空。您可以在 <samp>PHP信息</samp>页检查当前值。',
	'ERROR_DEFAULT_CHARSET'							=> '默认字符集配置不当。',
	'ERROR_DEFAULT_CHARSET_EXPLAIN'					=> '<var>default_charset</var> 必须设置为 <samp>UTF-8</samp>。 您可以在 <samp>PHP信息</samp>页检查当前值。',
...
$lang = array_merge($lang, array(
	...
	'LOG_PROFILE_FIELD_DEACTIVATE'	=> '<strong>资料栏目停用</strong><br />» %s',
	...
	'LOG_PRUNE_USER_DEAC'		=> '<strong>用户停用</strong><br />» %s',
	...
	'LOG_SPAMHAUS_OPEN_RESOLVER'		=> 'Spamhaus 不允许使用开放解释器。黑名单检查被禁用了。更多信息，请看 https://www.spamhaus.com/product/help-for-spamhaus-public-mirror-users/.',
	'LOG_SPAMHAUS_VOLUME_LIMIT'			=> '超过了 Spamhaus 查询的限制数量。黑名单检查被禁用。更多信息，请看 https://www.spamhaus.com/product/help-for-spamhaus-public-mirror-users/.',
	...
	'LOG_USER_INACTIVE'		=> '<strong>停用用户</strong><br />» %s',
	...
	'LOG_USER_INACTIVE_USER'	=> '<strong>用户帐号被停用</strong>',
