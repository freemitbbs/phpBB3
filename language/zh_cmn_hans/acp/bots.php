...
$lang = array_merge($lang, array(
	...
	'BOT_DELETED'		=> '机器人删除完成。',
	'BOT_EDIT'			=> '编辑机器人',
	'BOT_EDIT_EXPLAIN'	=> '这里您可以增加或修改当前的机器人条目。您可以设置一个代理字符串和/或多个 IP 地址(或者地址范围)来匹配。当设置匹配字符串时要小心。您也可以指定机器人浏览时看到的界面和语言。设定一个简单的界面风格样式可以减少机器人使用的带宽。记住给机器人用户组设置合适的权限。',
	'BOT_LANG'			=> '机器人语言',
	...
	'BOT_NEVER'			=> '从未',
	'BOT_STYLE'			=> '机器人风格样式',
	'BOT_STYLE_EXPLAIN'	=> '当机器人浏览时显示的风格样式。',
	'BOT_UPDATED'		=> '机器人更新完成。',

	'ERR_BOT_AGENT_MATCHES_UA'	=> '您提供的机器人代理和您现在使用的很相似。请调整这个机器人的代理。',
	'ERR_BOT_NO_IP'				=> '您提供的 IP 地址或主机名是无效的。',
	'ERR_BOT_NO_MATCHES'		=> '您必须为这个机器人提供至少一个匹配的代理或 IP 地址。',

	'NO_BOT'		=> '没有找到指定 ID 的机器人。',
