...
$lang = array_merge($lang, array(
	...
	'IP_INFO'				=> 'IP 地址信息',
	'IPS_POSTED_FROM'		=> '这个用户的发帖 IP 地址',

	'LATEST_LOGS'				=> '最近的 5 个操作记录',
	'LATEST_REPORTED'			=> '最近的 5 个举报',
	'LATEST_REPORTED_PMS'		=> '最近的 5 个站内短信举报',
	'LATEST_UNAPPROVED'			=> '最近 5 篇等待批准发布的帖子',
	'LATEST_WARNING_TIME'		=> '最近发出的警告',
	'LATEST_WARNINGS'			=> '最近的 5 个警告记录',
	'LEAVE_SHADOW'				=> '保留影子主题',
	'LIST_REPORTS'				=> array(
		1	=> '%d 报告',
	),
	...
	'MCP_BAN'					=> '封禁操作',
	'MCP_BAN_EMAILS'			=> '封禁 Email 地址',
	'MCP_BAN_IPS'				=> '封禁 IP 地址',
	...
	'MCP_QUEUE_DELETED_POSTS_EXPLAIN'		=> '这是一个列有软删除帖子的列表，您可以在这里恢复或者永久删除它们。',
	'MCP_QUEUE_DELETED_TOPICS'				=> '删除的主题',
	'MCP_QUEUE_DELETED_TOPICS_EXPLAIN'		=> '这是一个列有软删除主题的列表，您可以在这里恢复或者永久删除它们。',
	...
	'MERGE_TOPIC_EXPLAIN'	=> '使用下面的表单您可以将选中的帖子移动到另一个主题中。这些帖子将从这个主题分离然后合并到另一个主题。这些帖子不会被记录，就像用户将其发表在那个主题中一样。<br />请输入目标主题 ID 或者点击 "选择主题" 来找一个。',
	'MERGE_TOPIC_ID'		=> '目标主题 ID 号',
	'MERGE_TOPICS'			=> '合并主题',
	...
	'NO_TOPICS_QUEUE'				=> '没有等待批准的主题',

	'ONLY_TOPIC'			=> '只有主题  “%s”',
	'OTHER_USERS'			=> '用户从这个 IP 地址发表帖子',
	...
	'PM_REPORTS_CLOSED_SUCCESS'	=> '所选站内短信报告已成功关闭。',
	'PM_REPORTS_DELETED_SUCCESS'=> '所选站内短信报告已成功删除。',
	'PM_REPORTS_TOTAL'			=> array(
		0	=> '没有要检查的站内短信报告。',
		1	=> '总共有<strong>%d</strong>个站内短信举报待处理。',
	),
	'PM_REPORT_DETAILS'			=> '站内短信举报明细',
	'POSTER'					=> '作者',
	...
	'THIS_PM_IP'				=> '这个站內短信的 IP 地址',
	'THIS_POST_IP'				=> '这篇帖子的 IP 地址',
	...
	'WARNED_USERS'			=> '被警告的用户',
	'WARNED_USERS_EXPLAIN'	=> '有未过期警告的用户列表',
