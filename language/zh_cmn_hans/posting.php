...
$lang = array_merge($lang, array(
	...
	'ADD_FILE'					=> '添加文件',
	'ADD_POLL'					=> '添加投票',
	'ADD_POLL_EXPLAIN'			=> '如果您不想在主题中添加投票，请不要填写以下内容。',
	'ALREADY_DELETED'			=> '对不起，此内容已经被删除。',
	'ATTACH_COMMENT_NO_EMOJIS'	=> '附件的注释含有禁止的字符 （Emoji）。',
	...
	'MAX_ATTACHMENT_FILESIZE'	=> '每个附件最大文件尺寸： %s.',
	...
	'MESSAGE_BODY_EXPLAIN'		=> array(
		...
		1	=> '在这里输入您的信息，最多可包含 <strong>%d</strong> 个字符。',
	),
	...
	'POLL_DELETE'				=> '删除投票',
	'POLL_FOR'					=> '投票持续时间',
	'POLL_FOR_EXPLAIN'			=> '输入 0 保持投票永远开放。',
	...
	'POLL_QUESTION'				=> '投票问题',
	'POLL_TITLE_TOO_LONG'		=> '投票的问题不能大于 100 字符。',
	'POLL_TITLE_COMP_TOO_LONG'	=> '解析后的投票问题过长， 请删除一些 BBCode 或表情图标。',
	...
	'STICK_TOPIC_FOR_EXPLAIN'	=> '输入 0 将使主题成为永久全局公告，公告或置顶，请注意这个数字是相对于发帖时间。',
	...
	'UNAUTHORISED_BBCODE'		=> '您不能使用此 BBCodes：%s',
