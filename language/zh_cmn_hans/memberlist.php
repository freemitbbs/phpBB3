...
$lang = array_merge($lang, array(
	...
	'CC_SENDER'				=> '给您自己发送一份 Email 的拷贝',
	'CONTACT_ADMIN'			=> '联系论坛管理员',

	'DEST_LANG'				=> '语言',
	'DEST_LANG_EXPLAIN'		=> '选择一个合适的语言（如果可用）给收件人。',

	'EDIT_PROFILE'			=> '编辑资料',

	'EMAIL_BODY_EXPLAIN'	=> '邮件将以纯文本的形式发送，请不要包含任何 HTML 或 BBCode。这个邮件的返回地址将设置为您的 Email 地址。',
	...
	'EMPTY_SENDER_EMAIL'	=> '您必须提供一个有效的邮箱地址。',
	'EMPTY_SENDER_NAME'		=> '您必须提供发信者的称呼。',
	...
	'LOGIN_EXPLAIN_TEAM'		=> '论坛需要您注册并登录后查看团队列表。',
	...
	'VIEW_YOUTUBE_PROFILE'	=> '查看 YouTube 简介',
));
