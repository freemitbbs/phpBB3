...
$lang = array_merge($lang, [
	...
	'RECAPTCHA_NOT_AVAILABLE'		=> '要使用 reCaptcha，您必须在 <a href="https://www.google.com/recaptcha">www.google.com/recaptcha</a> 上建立一个账号。',
	'RECAPTCHA_INVISIBLE'			=> '此 CAPTCHA 实际工作时是不可见的。 为了验证它能正常工作，一个小图标会显示在当前页面的右下角。',
	'RECAPTCHA_V3_LOGIN_ERROR_ATTEMPTS'	=> '您已经超过了允许的最大登录尝试次数。<br>除了您的用户名和密码之外，不可见的 reCAPTCHA v3 将用于验证您的会话。',
	...
	'RECAPTCHA_V3_THRESHOLD_DEFAULT_EXPLAIN'	=> '当不是其它操作时使用。',
	...
	'RECAPTCHA_V3_THRESHOLDS_EXPLAIN'			=> 'reCAPTCHA v3 返回一个分数值 (<samp>1.0</samp> 就很可能是一个好的人机交互操作， <samp>0.0</samp> 非常有可能是机器人)。 此处您可以给每一个操作设置一个最低的分数值。',
