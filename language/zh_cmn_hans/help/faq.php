...
$lang = array_merge($lang, array(
	...
	'HELP_FAQ_UCP_OPTIONS_QUESTION' => '注册用户可以自定义哪些体验？',
	'HELP_FAQ_UCP_OPTIONS_ANSWER' => '注册并登录后，用户控制面板里有很多个性化选项。常用位置是“偏好设置”，其中“编辑全局设置”控制论坛风格、成人内容访问、版面页热门话题和主题自动移动等选项；“编辑显示设置”控制话题列表显示方式、预览和首页话题表隐藏版面等选项。',
	'HELP_FAQ_UCP_TOPIC_LIST_QUESTION' => '不喜欢增强版话题列表预览，怎样改回只看标题？',
	'HELP_FAQ_UCP_TOPIC_LIST_ANSWER' => '进入“用户控制面板” → “偏好设置” → “编辑显示设置”，把“显示增强版话题列表”设为“否”。保存后，话题列表会回到经典的标题列表样式，不再显示增强版摘要预览。',
	'HELP_FAQ_UCP_ADULT_ACCESS_QUESTION' => '如何开启或关闭成人内容访问？',
	'HELP_FAQ_UCP_ADULT_ACCESS_ANSWER' => '进入“用户控制面板” → “偏好设置” → “成人内容访问”。确认已满 18 周岁且符合所在地法律后，可以开启成人版块访问；之后也可以在同一页面关闭，关闭后相关版块会立即隐藏。',
	'HELP_FAQ_UCP_TOP_TOPICS_QUESTION' => '不想看到热门话题区块怎么办？',
	'HELP_FAQ_UCP_TOP_TOPICS_ANSWER' => '进入“用户控制面板” → “偏好设置” → “编辑全局设置”，把“在版面页面显示热门话题”设为“否”，即可移除各版面页顶部的热门话题区块。首页热门话题区块也可以用区块标题栏上的折叠按钮收起。',
	'HELP_FAQ_UCP_THEME_QUESTION' => '怎样换成不同的论坛风格？',
	'HELP_FAQ_UCP_THEME_ANSWER' => '进入“用户控制面板” → “偏好设置” → “编辑全局设置”，在“我的论坛风格”中选择喜欢的主题并保存。若管理员强制全站使用同一风格，个人风格选择可能不会生效。',
	'HELP_FAQ_UCP_TOPIC_MOVER_QUESTION' => '怎样不让我的主题被自动移出菌斑？',
	'HELP_FAQ_UCP_TOPIC_MOVER_ANSWER' => '进入“用户控制面板” → “偏好设置” → “编辑全局设置”，把“不要自动移动我的主题”设为“是”。开启后，主题自动移动会保留你发起的主题在原版面。',
	'HELP_FAQ_UCP_HIDE_FORUMS_QUESTION' => '怎样在首页隐藏某些版面？',
	'HELP_FAQ_UCP_HIDE_FORUMS_ANSWER' => '进入“用户控制面板” → “偏好设置” → “编辑显示设置”，在“从首页话题表中隐藏版面”里勾选不想出现在首页话题表中的版面。保存后，这些版面的主题不会出现在首页热门话题和最近更新话题列表中；你仍然可以直接进入有权限阅读的版面。',
