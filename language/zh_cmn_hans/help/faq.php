...
$lang = array_merge($lang, array(
	...
	'HELP_FAQ_BOOKMARKS_FORUM_ANSWER'	=> '订阅特定版面，进入该版面后，点击“订阅版面”链接，在页面底部。',
	'HELP_FAQ_BOOKMARKS_FORUM_QUESTION'	=> '我怎么订阅特定的版面？',
	...
	'HELP_FAQ_FORMATTING_BBOCDE_ANSWER'	=> 'BBCode 是一种特殊的 HTML 实现方式，能否使用 BBCode 由管理员决定 (您也可以在发表帖子的过程中禁用它)。BBCode 本身和 HTML 风格相似，每个标签用方括号 [ 和 ] 而不是 &lt; 和 &gt; ，并且这种方式提供更多的显示控制。要得到更多的信息请查看发帖页面中的 BBCode 帮助。',
	'HELP_FAQ_FORMATTING_BBOCDE_QUESTION'	=> '什么是 BBCode？',
	...
	'HELP_FAQ_FORMATTING_HTML_ANSWER'	=> '不可以。在这个论坛上不允许使用 HTML 发表帖子。大多数使用 HTML 生成的格式效果可以通过 BBCode 实现。',
	'HELP_FAQ_FORMATTING_HTML_QUESTION'	=> '我可以使用 HTML 吗？',
	'HELP_FAQ_FORMATTING_ICONS_ANSWER'	=> '主题图标由作者选择的，是和主题内容相关的一种小图片。是否可以使用主题图标取决于管理员的设置。',
	'HELP_FAQ_FORMATTING_ICONS_QUESTION'	=> '什么是主题图标？',
	'HELP_FAQ_FORMATTING_IMAGES_ANSWER'	=> '是的，在帖子中可以显示图片。如果管理员允许使用附件，您可以上传图片到论坛上。否则您必须在网上的公开访问服务器存储您的图片，e.g. http://www.example.com/my-picture.gif。您不能直接链接本地电脑上的图片 （除非您的电脑是一个公众可以访问的服务器），也不能链接图片到需要访问权限的地址，例如您的 hotmail 或者雅虎邮箱。要显示链接的图片，请使用 BBCode [img] 标签。',
	'HELP_FAQ_FORMATTING_IMAGES_QUESTION'	=> '我可以发表图片吗？',
	'HELP_FAQ_FORMATTING_LOCKED_ANSWER'	=> '锁定的主题将不能回复，其中包含的投票也自动结束了。主题的锁定可能有很多原因，通常由论坛版主或管理员锁定。如果有权限的话，您也可以锁定自己的主题。',
	...
	'HELP_FAQ_FRIENDS_BASIC_ANSWER'	=> '您可以使用这些列表来组织论坛中的其他用户。您的好友会在您的用户控制面板中列出，方便您快速查看在线状态和发送站内短信。另外在模板的支持下，您的好友所发表的文章也会以高亮显示。如果您将某个用户添加进了黑名单，他的帖子将自动对您隐藏。',
	'HELP_FAQ_FRIENDS_BASIC_QUESTION'	=> '什么是我的好友列表和黑名单？',
	...
	'HELP_FAQ_FRIENDS_MANAGE_QUESTION'	=> '我该如何于好友或黑名单中添加 / 删除用户？',
	...
	'HELP_FAQ_GROUPS_MODERATORS_ANSWER'	=> '版主是独立的用户或用户组，他们的工作是维护每个版面的日常运作。他们拥有所辖版面内部的编辑/删除/锁定/解锁/移动/分割主题和投票的权力。一般版主会阻止用户发表跑题文章或者垃圾文章。',
	'HELP_FAQ_GROUPS_MODERATORS_QUESTION'	=> '什么是版主？',
	'HELP_FAQ_GROUPS_TEAM_ANSWER'	=> '这个页面显示论坛的管理团队人员列表，包含论坛管理员，版主和其所在的版面信息。',
	'HELP_FAQ_GROUPS_TEAM_QUESTION'	=> '什么是 “管理团队” 链接？',
	...
	'HELP_FAQ_GROUPS_USERGROUPS_JOIN_ANSWER'	=> '要加入一个用户组请点击用户控制面板中的用户组链接，这样您可以看到所有的用户组。并不是所有的用户组都是 开放的，一些需要申请，一些是关闭的，而另一些甚至是隐藏的。如果是开放的用户组您可以直接点击加入。如果是需要申请的用户组，您需要先申请加入，而后等待用户组领导者批准后才能成为用户组的成员，这个过程中他们可能会询问您加入的原因。如果申请没有被批准，请不要纠缠用户组领导者，他们会告诉您没有批准的原因。',
	...
	'HELP_FAQ_ISSUES_ADMIN_ANSWER'	=> '所有论坛用户可使用“联系我们”表单，如果该选项被论坛管理员启用的话。<br />论坛会员也可以使用“管理团队”链接。',
	...
	'HELP_FAQ_LOGIN_CANNOT_LOGIN_ANYMORE_ANSWER'	=> '可能是管理员出于某种原因停用或删除了您的账号。也可能是为了减少数据库大小许多论坛会定期删除一些很久未发帖的用户。如果是这样，请重新注册并且多多参与讨论。',
	'HELP_FAQ_LOGIN_CANNOT_LOGIN_ANYMORE_QUESTION'	=> '我注册过帐号但是现在却无法登录了？！',
	'HELP_FAQ_LOGIN_CANNOT_REGISTER_ANSWER'	=> '这可能是因为网站管理者封禁了您所在的 IP 地址或禁止了您试图注册的用户名。也可能是因为网站管理者禁止了新用户注册。需要更多的信息请联络论坛管理员。',
	'HELP_FAQ_LOGIN_CANNOT_REGISTER_QUESTION'	=> '为什么我不能注册？',
	'HELP_FAQ_LOGIN_COPPA_ANSWER'	=> 'COPPA，是儿童在线隐私和保护条例的缩写，生效于1998年的美国法律。这项法律要求任何有可能收集年龄小于13周岁的未成年人信息的网站必须持有其监护人的同意书，或者其他形式的合法依据才能收集其身份信息。如果您不能确认此法律是否对您的行为有约束，请联络就近的律师以得到帮助。请注意 phpBB Limited 并不会提供任何法律建议，也不为各种法律事件提供观点和帮助，除非以下列出的情形：“对于论坛上诽谤，脏话和其他触及法律的事务，我该联络谁？”	',
	'HELP_FAQ_LOGIN_COPPA_QUESTION'	=> '什么是 COPPA？',
	'HELP_FAQ_LOGIN_DELETE_COOKIES_ANSWER'	=> '“删除 cookies”删除了 phpBB 论坛程序所创建的 cookies，这些 cookie 包含您在论坛上的认证信息和您在论坛上的活动记录等信息。如果论坛管理员启用阅读记录，也会被记录在 cookie 中。如果您有登录的问题，删除论坛 cookies 也许可以帮到您。',
	'HELP_FAQ_LOGIN_DELETE_COOKIES_QUESTION'	=> '“删除 cookies” 是什么意思？',
	'HELP_FAQ_LOGIN_LOST_PASSWORD_ANSWER'	=> '不用紧张! 您的密码虽然无法找回，但是可以重设。您到登录页面点击 <em>我忘记了自己的密码</em>，按提示的步骤您就可以很快取回您的帐号。',
	'HELP_FAQ_LOGIN_LOST_PASSWORD_QUESTION'	=> '我忘记了自己的密码!',
	'HELP_FAQ_LOGIN_REGISTER_ANSWER'	=> '您也许不必注册，这取决于论坛管理员设置是否需要您注册后才能发表帖子。但是注册将给您更多的权限来使用额外的论坛功能例如自定义头像，站内短信，给好友发送 email 和加入用户组，等等。只需要一点点时间就能完成注册，所以建议您注册一个帐号吧。',
	'HELP_FAQ_LOGIN_REGISTER_QUESTION'	=> '为什么我需要注册？',
	'HELP_FAQ_LOGIN_REGISTER_CONFIRM_ANSWER'	=> '首先确认您输入了正确的用户名和密码。如果都没错，可能会有两个原因。如果论坛支持 COPPA 并且您在注册时小于13岁，那您必须先按照您收到的提示完成规定的步骤。如果不是这个原因，是否会是因为您的帐号未被激活？ 一些论坛需要新用户在登录前由自己或由管理员激活。当您注册时论坛将告诉您是否需要激活。如果您收到了 email 就按照其中的步骤完成激活，如果您没有收到 email，您需要检查一下您的 email 地址是否正确，或者检查一下您的垃圾邮件。如果您确信 Email 地址没错请联络论坛管理员。',
	...
	'HELP_FAQ_PMS_SPAM_ANSWER'	=> '我们对这种情况非常抱歉。这个论坛的 email 系统带有用户发送跟踪系统，您应该给论坛管理员发送 email，随信附上您所收到的完整  email 说明您遭遇到的情况。完整的 email 非常重要，因为其中包含了 email 头信息 (发送 email 的用户的细节)。他们会受到相应的处罚。',
	'HELP_FAQ_PMS_SPAM_QUESTION'	=> '我收到了这个论坛里的成员发给我的垃圾 email 或者冒犯我的 email!',
	...
	'HELP_FAQ_POSTING_CREATE_ANSWER'	=> '在版面上发表新主题，请点击相应的按钮。要回复一个主题，点击回复按钮。您可能需要注册之后才能发表文章，您所拥有的权限列表显示在版面和文章页面的下方 (比如 您可以发表新主题，您可以参与投票，等等. 这样的列表)。',
	...
	'HELP_FAQ_POSTING_EDIT_DELETE_ANSWER'	=> '除非您是管理员或版主，您只能编辑或删除您自己的帖子。您可以点击“编辑”按钮编辑一个帖子 (有时必须在发表后的一段时间内)。如果有人已经回复过这篇帖子，您的修改会在帖子中留下一段修改的痕迹显示在帖子的下方，这将列出您修改的次数和时间。在没有回复的情况下不会显示，在管理员和版主修改的情况下也可能不会显示，除非他们决定留下一段记录说明他们编辑帖子的原因。请注意普通用户发表的帖子，在已经有回复的情况下不能被发帖者删除。',
	...
	'HELP_FAQ_POSTING_POLL_CREATE_ANSWER'	=> '您可以很容易地创建一个投票，当您发表或者修改文章的时候，如果您有相应的权限，您可以在页面下方看到一个 “建立投票” 的表单。您需要为投票输入一个标题和至少两个选项 (在问题栏中填写问题并点击 “添加选项” 按钮。在文字框内，每个选项单独一行。您可以设置投票的时间限制，按天算，如果是 0，则表示投票没有时间限制。您可以限定每个用户所允许的选择数目，还可以设置是否允许用户之后修改其投票。',
	'HELP_FAQ_POSTING_POLL_CREATE_QUESTION'	=> '我该如何创建一个投票？',
	'HELP_FAQ_POSTING_POLL_EDIT_ANSWER'	=> '投票只能由创建者或者版主，管理员修改。要编辑一个投票，点击编辑主题的第一篇帖子。如果还没有人参与投票，用户可以删除投票或编辑投票选项，但是一旦已经有人参与投票，就只有版主和管理员有权限编辑或删除它。这防止某些用户在后期修改选项。',
	'HELP_FAQ_POSTING_POLL_EDIT_QUESTION'	=> '我该如何编辑或删除一个投票？',
	'HELP_FAQ_POSTING_QUEUE_ANSWER'	=> '论坛管理员可能设置了论坛的帖子必须通过审核才能发表。这也可能是因为您被管理员放入了需要审核文章的会员列表。请联络论坛管理员以得到更多信息。',
	...
	'HELP_FAQ_POSTING_WARNING_ANSWER'	=> '每个论坛管理员对自己的论坛都有一套规则。如果他们觉得您在版面违反了规定，他们可能会对您发出一个警告。请注意这是论坛管理人员的决定，phpBB 开发者和这些警告没有任何关系。',
	...
	'HELP_FAQ_SEARCH_MEMBERS_ANSWER'	=> '到用户列表页面并点击 “查找一个用户” 。',
	...
	'HELP_FAQ_SEARCH_OWN_ANSWER'	=> '您自己的帖子可以通过点击用户控制面板或浏览自己的资料中 “显示您的帖子” 链接得到。要查找自己的主题，使用高级搜索，并填入自己的用户名和其他合适的条件进行查找。',
	...
	'HELP_FAQ_USERSETTINGS_AVATAR_DISPLAY_ANSWER'	=> '在您的控制面板里，“个人资料”下方您可以添加一个头像使用四种方法之一：Gravatar、相册、远程或上传。由论坛管理员决定启用头像和选择制作头像的方法。如果您不能使用头像，联系论坛管理员。',
	'HELP_FAQ_USERSETTINGS_AVATAR_DISPLAY_QUESTION'	=> '我怎么显示一个头像？',

	'HELP_FAQ_USERSETTINGS_CHANGE_SETTINGS_ANSWER'	=> '您的所有设定 (如果您是注册用户) 都存储在数据库中。要修改它们请点击 “用户控制面板” 链接 (除了这个以外，一般都显示在每页的页首)。您可以在用户控制面板中更改您的各种偏好设定。',
	'HELP_FAQ_USERSETTINGS_CHANGE_SETTINGS_QUESTION'	=> '我该如何更改设置？',
	'HELP_FAQ_USERSETTINGS_EMAIL_LOGIN_ANSWER'	=> '对不起只有注册用户才能通过论坛发送 email 给其他用户 (如果管理员启用了 email 功能)。这主要是为了防止匿名用户使用 email 系统发送垃圾邮件。',
	'HELP_FAQ_USERSETTINGS_EMAIL_LOGIN_QUESTION'	=> '当我点击用户的 email 链接时为什么要让我登录？',
	'HELP_FAQ_USERSETTINGS_HIDE_ONLINE_ANSWER'	=> '在用户控制面板 “论坛参数” 中您可以找到选项 <em>隐藏您的在线状态</em>，如果您选中这个选项，将只有管理员，版主和您自己能看到您的在线状态。您将会显示为隐藏用户。',
