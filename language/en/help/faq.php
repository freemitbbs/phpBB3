...
$lang = array_merge($lang, array(
	...
	'HELP_FAQ_BLOCK_UCP' => 'User Control Panel',
	...
	'HELP_FAQ_UCP_OPTIONS_QUESTION' => 'What can registered users customize?',
	'HELP_FAQ_UCP_OPTIONS_ANSWER' => 'Registered users have many options in the User Control Panel. Most of them are under Board preferences: Edit global settings controls your board style, adult-content access, forum-page Top Topics, and topic auto-moving preferences; Edit display options controls topic-list display, previews, and forums hidden from homepage topic lists.',
	'HELP_FAQ_UCP_TOPIC_LIST_QUESTION' => 'How do I switch away from enhanced topic-list previews?',
	'HELP_FAQ_UCP_TOPIC_LIST_ANSWER' => 'Open User Control Panel → Board preferences → Edit display options, then set "Show enhanced topic list view" to "No". After saving, topic lists use the classic title-list layout and no longer show enhanced excerpt previews.',
	'HELP_FAQ_UCP_ADULT_ACCESS_QUESTION' => 'How do I enable or disable adult-content access?',
	'HELP_FAQ_UCP_ADULT_ACCESS_ANSWER' => 'Open User Control Panel → Board preferences → Adult content access. After confirming that you are at least 18 and that viewing adult content is lawful where you live, you can enable adult forum access. You can disable it later from the same page, which immediately hides those forums again.',
	'HELP_FAQ_UCP_TOP_TOPICS_QUESTION' => 'How do I remove the Top Topics section?',
	'HELP_FAQ_UCP_TOP_TOPICS_ANSWER' => 'Open User Control Panel → Board preferences → Edit global settings and set "Show Top Topics on forum pages" to "No" to remove the Top Topics block from individual forum pages. The homepage Top Topics block can also be collapsed from the block header.',
	'HELP_FAQ_UCP_THEME_QUESTION' => 'How do I change to a different theme?',
	'HELP_FAQ_UCP_THEME_ANSWER' => 'Open User Control Panel → Board preferences → Edit global settings, choose a theme under "My board style", and save. If administrators force one site-wide style, your personal style choice may not take effect.',
	'HELP_FAQ_UCP_TOPIC_MOVER_QUESTION' => 'How do I prevent my topics from being auto-moved out of Junban?',
	'HELP_FAQ_UCP_TOPIC_MOVER_ANSWER' => 'Open User Control Panel → Board preferences → Edit global settings and set "Do not automatically move my topics" to "Yes". When enabled, the topic auto-mover keeps topics you start in their original forum.',
	'HELP_FAQ_UCP_HIDE_FORUMS_QUESTION' => 'How do I hide forums on the homepage?',
	'HELP_FAQ_UCP_HIDE_FORUMS_ANSWER' => 'Open User Control Panel → Board preferences → Edit display options, then select forums under "Hide forums from homepage topic lists". After saving, topics from those forums will not appear in homepage Top Topics or Recent Topics lists; you can still visit forums you are allowed to read directly.',
